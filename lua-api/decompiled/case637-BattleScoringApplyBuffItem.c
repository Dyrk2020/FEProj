...
void case637_BattleScoringApplyBuffItem(undefined8 param_1)

{
  ...
  func_0x01910af0(&uStack_40,&"BattleScoringApplyBuffItem",&uStack_50,0x736d101);
  uVar3 = func_0x019108e0(&uStack_40,&"skillUseGuid",&UNK_01910ac8,0,&UNK_01910ad0,0);
  puVar4 = (undefined8 *)func_0x019108e0(uVar3,&"skillUseCount",&UNK_01910ad8,0,&UNK_01910ae0,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_01910ae8;
  func_0x0124ec90(*puVar4,&UNK_019110d4,1);
  ...
  func_0x0124f120(uVar3,&"buffTypeDic");
