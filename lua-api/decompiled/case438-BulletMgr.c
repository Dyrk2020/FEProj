...
void case438_BulletMgr(undefined8 param_1)

{
  ...
  func_0x018662a0(&uStack_40,&"BulletMgr",&uStack_50,0x736d101);
  uVar3 = func_0x01866080(&uStack_40,&"profilerIndex",&UNK_01866268,0,&UNK_01866270,0);
  puVar4 = (undefined8 *)func_0x01866080(uVar3,&"updateCount",&UNK_01866278,0,&UNK_01866280,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_01866288;
  func_0x0124ec90(*puVar4,&UNK_01866884,1);
  ...
  func_0x0124f120(uVar3,&"bulletGroups");
  ...
  func_0x0124e060(uVar3,uVar2);
  func_0x0124c4d0(uVar3,0xfffffffd);
  puVar4 = (undefined8 *)func_0x01866080(puVar4,&"groupObjId",&UNK_01866290,0,&UNK_01866298,0);
