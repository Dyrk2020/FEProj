...
void case110_UnitSelectorTypeResObject(undefined8 param_1)

{
  ...
  func_0x0178bd00(&uStack_30,&"UnitSelectorTypeResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0178bcf8;
  func_0x0124ec90(uStack_30,&UNK_0178c0c4,1);
  ...
  func_0x0124f120(uVar1,&"unitSelectorTypeList");
