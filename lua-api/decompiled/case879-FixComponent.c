...
void case879_FixComponent(undefined8 param_1)

{
  ...
  func_0x01a1866c(&uStack_40,&"FixComponent",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x01a18260(&uStack_40,&"enabled",&UNK_01a18448,0,&UNK_01a18450,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01a1846c;
  func_0x0124ec90(*puVar3,&UNK_01a18d48,1);
  ...
  func_0x0124f120(uVar5,&"fixObject");
  ...
  func_0x0124e060(uVar5,uVar2);
  func_0x0124c4d0(uVar5,0xfffffffd);
  puVar3 = (undefined8 *)func_0x01a18474(puVar3,&"profilerIndex",&UNK_01a1865c,0,&UNK_01a18664,0);
