...
void case820_ReflectTransferData(undefined8 param_1)

{
  ...
  func_0x019c805c(&uStack_40,&"ReflectTransferData",&uStack_50,0x736d101);
  uVar3 = func_0x019c7ca4(&uStack_40,&"curSkillGuid",&UNK_019c7e8c,0,&UNK_019c7e94,0);
  uVar3 = func_0x019c7ca4(uVar3,&"sourceObjId",&UNK_019c7f24,0,&UNK_019c7f2c,0);
  puVar4 = (undefined8 *)func_0x019c7ca4(uVar3,&"sourceSkillGuid",&UNK_019c7fbc,0,&UNK_019c7fc4,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_019c8054;
  func_0x0124ec90(*puVar4,&UNK_019c8640,1);
  ...
  func_0x0124f120(uVar3,&"buffList");
