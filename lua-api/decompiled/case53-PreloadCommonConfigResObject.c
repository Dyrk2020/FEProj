...
void case53_PreloadCommonConfigResObject(undefined8 param_1)

{
  ...
  func_0x0176be50(&uStack_30,&"PreloadCommonConfigResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0176be48;
  func_0x0124ec90(uStack_30,&UNK_0176c214,1);
