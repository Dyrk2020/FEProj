...
void case807_SkillStateMgr(undefined8 param_1)

{
  ...
  func_0x019be048(&uStack_40,&"SkillStateMgr",&uStack_50,0x736d101);
  uVar3 = func_0x019bde14(&uStack_40,&"currnetState",&UNK_019bdffc,0,&UNK_019be004,0);
  uVar3 = func_0x019bde14(uVar3,&"currentStateStartFrameCount",&UNK_019be020,0,&UNK_019be028,0);
  puVar4 = (undefined8 *)func_0x019bde14(uVar3,&"previousStateStartFrameCount",&UNK_019be030,0,&UNK_019be038,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_019be040;
  func_0x0124ec90(*puVar4,&UNK_019be794,1);
