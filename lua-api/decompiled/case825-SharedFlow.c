...
void case825_SharedFlow(undefined8 param_1)

{
  ...
  func_0x019d2050(&uStack_30,&"SharedFlow",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019d2048;
  func_0x0124ec90(uStack_30,&UNK_019d2414,1);
