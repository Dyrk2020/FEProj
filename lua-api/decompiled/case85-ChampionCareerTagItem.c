...
void case85_ChampionCareerTagItem(undefined8 param_1)

{
  ...
  func_0x01780198(&uStack_30,&"ChampionCareerTagItem",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_0177ff88;
  func_0x0124ec90(uStack_30,&UNK_0178055c,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x0177ff90(&uStack_30,&"iIncludeTag",&UNK_01780178,0,&UNK_01780180,0);
  puVar3 = (undefined8 *)func_0x0177ff90(uVar4,&"iExcludeTag",&UNK_01780188,0,&UNK_01780190,0);
