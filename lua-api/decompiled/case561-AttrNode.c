...
void case561_AttrNode(undefined8 param_1)

{
  ...
  func_0x018cdbc8(&uStack_40,&"AttrNode",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x018cd940(&uStack_40,&"constantGet",&UNK_018cdb28,0,&UNK_018cdb30,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018cdbc0;
  func_0x0124ec90(*puVar3,&UNK_018ce1ac,1);
