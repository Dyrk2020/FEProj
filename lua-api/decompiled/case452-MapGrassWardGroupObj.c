...
void case452_MapGrassWardGroupObj(undefined8 param_1)

{
  ...
  func_0x0186dff4(&uStack_30,&"MapGrassWardGroupObj",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0186dfec;
  func_0x0124ec90(uStack_30,&UNK_0186e3b8,1);
  ...
  func_0x0124f120(uVar1,&"mapGrassWardList");
