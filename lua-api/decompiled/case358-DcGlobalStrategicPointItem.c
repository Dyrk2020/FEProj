...
void case358_DcGlobalStrategicPointItem(undefined8 param_1)

{
  ...
  func_0x01821e88(&uStack_40,&"DcGlobalStrategicPointItem",&uStack_50,0x736d101);
  uVar3 = func_0x01821c78(&uStack_40,&"camp",&UNK_01821e60,0,&UNK_01821e68,0);
  puVar4 = (undefined8 *)func_0x01821c78(uVar3,&"seq",&UNK_01821e70,0,&UNK_01821e78,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_01821e80;
  func_0x0124ec90(*puVar4,&UNK_0182246c,1);
  ...
  func_0x0124f120(uVar3,&"extraSPData");
