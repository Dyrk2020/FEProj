// ===== case660-ActorComponentSelectHeroInteract @ 017165bc =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case660-ActorComponentSelectHeroInteract


void case660_ActorComponentSelectHeroInteract(undefined8 param_1)

{
  ...
  func_0x019317fc(&uStack_30,&"ActorComponentSelectHeroInteract",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019315e8;
  func_0x0124ec90(uStack_30,&UNK_01931bc0,1);
  ...
  func_0x0124f120(uVar2,&"selectedHero");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x019315f0(&uStack_30,&"markHeroType",&UNK_019317d8,0,&UNK_019317e0,0);
