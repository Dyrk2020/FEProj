// ===== case790-WorkFlowSerializedObject @ 017324f4 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case790-WorkFlowSerializedObject


void case790_WorkFlowSerializedObject(undefined8 param_1)

{
  ...
  func_0x019b0d14(&uStack_40,&"WorkFlowSerializedObject",&uStack_50,0x736d101);
  uVar3 = func_0x019b091c(&uStack_40,&"dirty",&UNK_019b0b04,0,&UNK_019b0b0c,0);
  puVar4 = (undefined8 *)func_0x019b0b14(uVar3,&"id",&UNK_019b0cfc,0,&UNK_019b0d04,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_019b0d0c;
  func_0x0124ec90(*puVar4,&UNK_019b1518,1);
  ...
  func_0x0124f120(uVar3,&"parentRes");
