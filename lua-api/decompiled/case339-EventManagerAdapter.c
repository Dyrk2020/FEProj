// ===== case339-EventManagerAdapter @ 016ce1ac =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case339-EventManagerAdapter


void case339_EventManagerAdapter(undefined8 param_1)

{
  ...
  func_0x01812b7c(&uStack_30,&"EventManagerAdapter",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01812b74;
  func_0x0124ec90(uStack_30,&UNK_01812f40,1);
  ...
  func_0x0124f120(uVar1,&"m_dicEventAdapters");
