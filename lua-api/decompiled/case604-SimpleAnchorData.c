// ===== case604-SimpleAnchorData @ 01708710 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case604-SimpleAnchorData


void case604_SimpleAnchorData(undefined8 param_1)

{
  ...
  func_0x018f58b4(&uStack_30,&"SimpleAnchorData",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018f58ac;
  func_0x0124ec90(uStack_30,&UNK_018f5c78,1);
  ...
  func_0x0124f120(uVar1,&"simpleAnchorLevelDict");
