...
void case752_MultiSkillObjCacheInfo(undefined8 param_1)

{
  ...
  func_0x0198af54(&uStack_30,&"MultiSkillObjCacheInfo",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0198ad54;
  func_0x0124ec90(uStack_30,&UNK_0198b318,1);
  ...
  func_0x0124f120(uVar2,&"skillObjs");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x0198ad5c(&uStack_30,&"addFrame",&UNK_0198af44,0,&UNK_0198af4c,0);
