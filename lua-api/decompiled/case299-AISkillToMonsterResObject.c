...
void case299_AISkillToMonsterResObject(undefined8 param_1)

{
  ...
  func_0x017f531c(&uStack_30,&"AISkillToMonsterResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017f5314;
  func_0x0124ec90(uStack_30,&UNK_017f56e0,1);
  ...
  func_0x0124f120(uVar1,&"aiSkillToMonsterList");
