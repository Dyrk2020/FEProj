...
void case810_ParallelFlowNode(undefined8 param_1)

{
  ...
  func_0x019c0798(&uStack_30,&"ParallelFlowNode",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019c0590;
  func_0x0124ec90(uStack_30,&UNK_019c0b5c,1);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_019c0598;
  func_0x0124ec90(uStack_30,&UNK_019c0c80,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar2 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar2,0xfffffffe);
  uVar3 = func_0x0124e920(uVar2,0xfffffffe);
  func_0x0124f120(uVar2,&"m_nodeMgr");
  func_0x0124cfc0(uVar2,0xfffffffe,1);
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  uVar2 = uStack_30;
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x019c05a0(&uStack_30,&"m_refInvoking",&UNK_019c0788,0,&UNK_019c0790,0);
