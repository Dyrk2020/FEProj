...
void case194_RelatedSlotGemWhiteConfig(undefined8 param_1)

{
  ...
  func_0x017b7f00(&uStack_40,&"RelatedSlotGemWhiteConfig",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x017b7d00(&uStack_40,&"slotIndex",&UNK_017b7ee8,0,&UNK_017b7ef0,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017b7ef8;
  func_0x0124ec90(*puVar3,&UNK_017b84e4,1);
  ...
  func_0x0124f120(uVar5,&"configItem");
