...
void case83_ChampionSpellBookCareerTagItem(undefined8 param_1)

{
  ...
  func_0x0177f390(&uStack_30,&"ChampionSpellBookCareerTagItem",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_0177f180;
  func_0x0124ec90(uStack_30,&UNK_0177f754,1);
  ...
  func_0x0124f120(uVar4,&"championAsset");
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x0177f188(&uStack_30,&"iIncludeTag",&UNK_0177f370,0,&UNK_0177f378,0);
  puVar3 = (undefined8 *)func_0x0177f188(uVar4,&"iExcludeTag",&UNK_0177f380,0,&UNK_0177f388,0);
