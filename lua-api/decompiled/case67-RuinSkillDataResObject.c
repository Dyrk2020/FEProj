// ===== case67-RuinSkillDataResObject @ 016976d4 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case67-RuinSkillDataResObject


void case67_RuinSkillDataResObject(undefined8 param_1)

{
  ...
  func_0x017751f8(&uStack_30,&"RuinSkillDataResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017751f0;
  func_0x0124ec90(uStack_30,&UNK_017755bc,1);
  ...
  func_0x0124f120(uVar1,&"ruinSkillDataList");
