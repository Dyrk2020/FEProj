// ===== case26-LuaFrameDataMgr @ 01690930 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case26-LuaFrameDataMgr


void case26_LuaFrameDataMgr(undefined8 param_1)

{
  ...
  func_0x0175c58c(&uStack_30,&"LuaFrameDataMgr",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0175c57c;
  func_0x0124ec90(uStack_30,&UNK_0175c950,1);
  ...
  func_0x0124f120(uVar1,&"structMaker");
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_0175c584;
  func_0x0124ec90(uStack_30,&UNK_0175ca74,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar1,0xfffffffe);
  uVar3 = func_0x0124e920(uVar1,0xfffffffe);
  func_0x0124f120(uVar1,&"luaMap");
  func_0x0124cfc0(uVar1,0xfffffffe,1);
  func_0x0124e060(uVar1,uVar3);
  func_0x0124c4d0(uVar1,0xfffffffd);
  uVar1 = uStack_30;
