...
void case420_RemakeMgr(undefined8 param_1)

{
  ...
  func_0x0185cc84(&uStack_30,&"RemakeMgr",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_0185ca60;
  func_0x0124ec90(uStack_30,&UNK_0185d048,1);
  ...
  func_0x0124f120(uVar4,&"remakeApprovedTeam");
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x0185ca68(&uStack_30,&"isRemakeSwitchOff",&UNK_0185cc50,0,&UNK_0185cc58,0);
  puVar3 = (undefined8 *)func_0x0185ca68(uVar4,&"isAutoTriggerRemake",&UNK_0185cc60,0,&UNK_0185cc68,0);
