...
void case593_MapConfigResObject(undefined8 param_1)

{
  ...
  func_0x018eea08(&uStack_30,&"MapConfigResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018eea00;
  func_0x0124ec90(uStack_30,&UNK_018eedcc,1);
  ...
  func_0x0124f120(uVar1,&"mapNodes");
