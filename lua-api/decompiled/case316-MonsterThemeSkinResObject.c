...
void case316_MonsterThemeSkinResObject(undefined8 param_1)

{
  ...
  func_0x017fcfac(&uStack_30,&"MonsterThemeSkinResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017fcfa4;
  func_0x0124ec90(uStack_30,&UNK_017fd370,1);
