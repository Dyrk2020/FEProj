// ===== case189-SkillGemBlackWhiteSetResObject @ 016ad15c =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case189-SkillGemBlackWhiteSetResObject


void case189_SkillGemBlackWhiteSetResObject(undefined8 param_1)

{
  ...
  func_0x017b5c30(&uStack_30,&"SkillGemBlackWhiteSetResObject* >",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017b5c20;
  func_0x0124ec90(uStack_30,&UNK_017b5ff4,1);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_017b5c28;
  func_0x0124ec90(uStack_30,&UNK_017b6118,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar1,0xfffffffe);
