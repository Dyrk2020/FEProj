...
void case609_MapAnchorMgr(undefined8 param_1)

{
  ...
  func_0x018f97d8(&uStack_40,&"MapAnchorMgr",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_40,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_018f9538;
  func_0x0124ec90(uStack_40,&UNK_018f9b9c,1);
  ...
  func_0x0124e060(uVar5,uVar2);
  func_0x0124c4d0(uVar5,0xfffffffd);
  puVar3 = (undefined8 *)func_0x018f9540(&uStack_40,&"mapIndex",&UNK_018f9728,0,&UNK_018f9730,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018f97c8;
  func_0x0124ec90(*puVar3,&UNK_018f9ee0,1);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_018f97d0;
  func_0x0124ec90(*puVar3,&UNK_018fa004,1);
  func_0x0124c0c0(*puVar3,0xffffffff);
  uVar5 = *puVar3;
  func_0x0124a650(uVar5,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar5,0xfffffffe);
  uVar2 = func_0x0124e920(uVar5,0xfffffffe);
  func_0x0124f120(uVar5,&"anchorMap");
  func_0x0124cfc0(uVar5,0xfffffffe,1);
  func_0x0124e060(uVar5,uVar2);
  func_0x0124c4d0(uVar5,0xfffffffd);
  uVar5 = *puVar3;
