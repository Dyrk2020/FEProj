// ===== case672-SkinBulletReplace @ 017185bc =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case672-SkinBulletReplace


void case672_SkinBulletReplace(undefined8 param_1)

{
  ...
  func_0x0193f124(&uStack_40,&"SkinBulletReplace",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0193ef24(&uStack_40,&"bulletId",&UNK_0193f10c,0,&UNK_0193f114,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0193f11c;
  func_0x0124ec90(*puVar3,&UNK_0193f708,1);
  ...
  func_0x0124f120(uVar5,&"actionInfo");
