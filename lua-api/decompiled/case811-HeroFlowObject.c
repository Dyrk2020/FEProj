...
void case811_HeroFlowObject(undefined8 param_1)

{
  ...
  func_0x019c0fcc(&uStack_30,&"HeroFlowObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019c0fc4;
  func_0x0124ec90(uStack_30,&UNK_019c1390,1);
