// ===== case646-SkillDefaultRangeStrengthenData @ 01714608 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case646-SkillDefaultRangeStrengthenData


void case646_SkillDefaultRangeStrengthenData(undefined8 param_1)

{
  ...
  func_0x01924258(&uStack_30,&"SkillDefaultRangeStrengthenData",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01924250;
  func_0x0124ec90(uStack_30,&UNK_0192461c,1);
  ...
  func_0x0124f120(uVar1,&"typeDatas");
