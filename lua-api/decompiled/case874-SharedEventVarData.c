// ===== case874-SharedEventVarData @ 017490f8 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case874-SharedEventVarData


void case874_SharedEventVarData(undefined8 param_1)

{
  ...
  func_0x01a15ac4(&uStack_30,&"SharedEventVarData",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01a158bc;
  func_0x0124ec90(uStack_30,&UNK_01a15e88,1);
  ...
  func_0x0124f120(uVar2,&"parallelFlowVar");
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_01a158c4;
  func_0x0124ec90(uStack_30,&UNK_01a15fac,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar2 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar2,0xfffffffe);
  uVar3 = func_0x0124e920(uVar2,0xfffffffe);
  func_0x0124f120(uVar2,&"flowVar");
  func_0x0124cfc0(uVar2,0xfffffffe,1);
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  uVar2 = uStack_30;
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x01a158cc(&uStack_30,&"type",&UNK_01a15ab4,0,&UNK_01a15abc,0);
