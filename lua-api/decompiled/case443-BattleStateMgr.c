...
void case443_BattleStateMgr(undefined8 param_1)

{
  ...
  func_0x018692a8(&uStack_40,&"BattleStateMgr",&uStack_50,0x736d101);
  uVar3 = func_0x01868e44(&uStack_40,&"isBattleFinish",&UNK_0186902c,0,&UNK_01869034,0);
  puVar4 = (undefined8 *)func_0x01869050(uVar3,&"battleFinishTime",&UNK_01869238,0,&UNK_01869240,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_018692a0;
  func_0x0124ec90(*puVar4,&UNK_01869da8,1);
  ...
  func_0x0124f120(uVar3,&"currentState");
