...
void case234_GainProbResObject(undefined8 param_1)

{
  ...
  func_0x017cc31c(&uStack_30,&"GainProbResObject* >",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017cc30c;
  func_0x0124ec90(uStack_30,&UNK_017cc6e0,1);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_017cc314;
  func_0x0124ec90(uStack_30,&UNK_017cc804,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar1,0xfffffffe);
