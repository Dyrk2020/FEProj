...
void case751_MultiSkillHurtInfoSkillRef(undefined8 param_1)

{
  ...
  func_0x0198a86c(&uStack_30,&"MultiSkillHurtInfoSkillRef",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0198a864;
  func_0x0124ec90(uStack_30,&UNK_0198ac30,1);
