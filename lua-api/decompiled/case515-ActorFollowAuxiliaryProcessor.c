...
void case515_ActorFollowAuxiliaryProcessor(undefined8 param_1)

{
  ...
  func_0x018a1e74(&uStack_30,&"ActorFollowAuxiliaryProcessor",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018a1e6c;
  func_0x0124ec90(uStack_30,&UNK_018a2238,1);
  ...
  func_0x0124f120(uVar1,&"universalOpConfig");
