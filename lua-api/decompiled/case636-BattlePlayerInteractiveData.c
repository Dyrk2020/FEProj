...
void case636_BattlePlayerInteractiveData(undefined8 param_1)

{
  ...
  func_0x019103f8(&uStack_30,&"BattlePlayerInteractiveData",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019103f0;
  func_0x0124ec90(uStack_30,&UNK_019107bc,1);
  ...
  func_0x0124f120(uVar1,&"allyInteractiveData");
