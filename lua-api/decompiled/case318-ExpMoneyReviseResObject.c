...
void case318_ExpMoneyReviseResObject(undefined8 param_1)

{
  ...
  func_0x017fdea0(&uStack_30,&"ExpMoneyReviseResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017fdca0;
  func_0x0124ec90(uStack_30,&UNK_017fe264,1);
  ...
  func_0x0124f120(uVar2,&"reviseData");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x017fdca8(&uStack_30,&"maxLevelExpMoneyReviseStateNum",&UNK_017fde90,0,&UNK_017fde98,0);
