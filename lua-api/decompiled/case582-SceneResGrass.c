...
void case582_SceneResGrass(undefined8 param_1)

{
  ...
  func_0x018e7558(&uStack_30,&"SceneResGrass",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018e7358;
  func_0x0124ec90(uStack_30,&UNK_018e791c,1);
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x018e7360(&uStack_30,&"grassId",&UNK_018e7548,0,&UNK_018e7550,0);
