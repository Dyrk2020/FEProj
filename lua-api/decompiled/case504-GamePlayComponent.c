...
void case504_GamePlayComponent(undefined8 param_1)

{
  ...
  func_0x0189765c(&uStack_40,&"GamePlayComponent",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x01897424(&uStack_40,&"resID",&UNK_0189760c,0,&UNK_01897614,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01897630;
  func_0x0124ec90(*puVar3,&UNK_01897da8,1);
  ...
  func_0x0124f120(uVar5,&"m_parallelFlowMgr");
  ...
  func_0x0124e060(uVar5,uVar2);
  func_0x0124c4d0(uVar5,0xfffffffd);
  puVar3 = (undefined8 *)func_0x01897424(puVar3,&"battleId",&UNK_01897638,0,&UNK_01897640,0);
