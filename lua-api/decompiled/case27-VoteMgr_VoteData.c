...
void case27_VoteMgr_VoteData(undefined8 param_1)

{
  ...
  func_0x0175cdd0(&uStack_30,&"VoteMgr_VoteData",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_0175cb98;
  func_0x0124ec90(uStack_30,&UNK_0175d194,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x0175cba0(&uStack_30,&"voteType",&UNK_0175cd88,0,&UNK_0175cd90,0);
  puVar3 = (undefined8 *)func_0x0175cba0(uVar4,&"frame",&UNK_0175cdac,0,&UNK_0175cdb4,0);
