...
void case635_BattleAllyInteractiveData(undefined8 param_1)

{
  ...
  func_0x0190ff08(&uStack_30,&"BattleAllyInteractiveData",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0190ff00;
  func_0x0124ec90(uStack_30,&UNK_019102cc,1);
  ...
  func_0x0124f120(uVar1,&"allyInteractiveDataDic");
