...
void case847_SkillSlotVariant(undefined8 param_1)

{
  ...
  func_0x019e4b60(&uStack_40,&"SkillSlotVariant",&uStack_50,0x736d101);
  uVar3 = func_0x019e46f8(&uStack_40,&"canLevelUp",&UNK_019e48e0,0,&UNK_019e48e8,0);
  uVar3 = func_0x019e46f8(uVar3,&"canAutoAttack",&UNK_019e4904,0,&UNK_019e490c,0);
  uVar3 = func_0x019e4928(uVar3,&"castSkillID",&UNK_019e4b10,0,&UNK_019e4b18,0);
  puVar4 = (undefined8 *)func_0x019e4928(uVar3,&"priority",&UNK_019e4b34,0,&UNK_019e4b3c,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_019e4b58;
  func_0x0124ec90(*puVar4,&UNK_019e5904,1);
