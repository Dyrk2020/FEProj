...
void case772_BattleBlock(undefined8 param_1)

{
  ...
  func_0x019a1044(&uStack_40,&"BattleBlock",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x019a0bac(&uStack_40,&"filterID",&UNK_019a0d94,0,&UNK_019a0d9c,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019a0e34;
  func_0x0124ec90(*puVar3,&UNK_019a1628,1);
  ...
  func_0x0124f120(uVar5,&"shapeComponent");
  ...
  func_0x0124e060(uVar5,uVar2);
  func_0x0124c4d0(uVar5,0xfffffffd);
  uVar5 = func_0x019a0e3c(puVar3,&"ignoreBulletBeginBlock",&UNK_019a1024,0,&UNK_019a102c,0);
  puVar3 = (undefined8 *)func_0x019a0e3c(uVar5,&"isUsingCompleteCheckAtFirst",&UNK_019a1034,0,&UNK_019a103c,0);
