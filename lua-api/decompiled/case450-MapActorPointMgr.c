...
void case450_MapActorPointMgr(undefined8 param_1)

{
  ...
  func_0x0186d328(&uStack_30,&"MapActorPointMgr",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0186d320;
  func_0x0124ec90(uStack_30,&UNK_0186d6ec,1);
  ...
  func_0x0124f120(uVar1,&"mapActorPointList");
