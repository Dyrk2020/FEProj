...
void case114_WeightedProximityTemplateResObject(undefined8 param_1)

{
  ...
  func_0x0178e1c4(&uStack_30,&"WeightedProximityTemplateResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0178e1bc;
  func_0x0124ec90(uStack_30,&UNK_0178e588,1);
  ...
  func_0x0124f120(uVar1,&"weightedProximityTemplateList");
