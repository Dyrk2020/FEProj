...
void case469_GamePlayComponentGroupRefResObject(undefined8 param_1)

{
  ...
  func_0x01877d24(&uStack_30,&"GamePlayComponentGroupRefResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01877d1c;
  func_0x0124ec90(uStack_30,&UNK_018780e8,1);
  ...
  func_0x0124f120(uVar1,&"groupAsset");
