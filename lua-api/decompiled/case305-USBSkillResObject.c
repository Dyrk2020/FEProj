...
void case305_USBSkillResObject(undefined8 param_1)

{
  ...
  func_0x017f7fe0(&uStack_30,&"USBSkillResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017f7de0;
  func_0x0124ec90(uStack_30,&UNK_017f83a4,1);
  ...
  func_0x0124f120(uVar2,&"usbSkillList");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x017f7de8(&uStack_30,&"MaxUSBSkillClassesNum",&UNK_017f7fd0,0,&UNK_017f7fd8,0);
