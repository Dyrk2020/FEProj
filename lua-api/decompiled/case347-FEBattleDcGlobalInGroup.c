...
void case347_FEBattleDcGlobalInGroup(undefined8 param_1)

{
  ...
  func_0x01818324(&uStack_30,&"FEBattleDcGlobalInGroup",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0181831c;
  func_0x0124ec90(uStack_30,&UNK_018186e8,1);
  ...
  func_0x0124f120(uVar1,&"playersPos");
