...
void case342_BattleTaskBase(undefined8 param_1)

{
  ...
  func_0x018149ec(&uStack_40,&"BattleTaskBase",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x018147ec(&uStack_40,&"battleType",&UNK_018149d4,0,&UNK_018149dc,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018149e4;
  func_0x0124ec90(*puVar3,&UNK_01814fd0,1);
