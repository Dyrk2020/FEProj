// ===== case665-DelayDestroyStealInfo @ 017171b0 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case665-DelayDestroyStealInfo


void case665_DelayDestroyStealInfo(undefined8 param_1)

{
  ...
  func_0x01937cec(&uStack_30,&"DelayDestroyStealInfo",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01937aec;
  func_0x0124ec90(uStack_30,&UNK_019380b0,1);
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x01937af4(&uStack_30,&"startTime",&UNK_01937cdc,0,&UNK_01937ce4,0);
