...
void case86_ChampionCareerTagResObject(undefined8 param_1)

{
  ...
  func_0x017808a8(&uStack_30,&"ChampionCareerTagResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017808a0;
  func_0x0124ec90(uStack_30,&UNK_01780c6c,1);
