...
void case523_ActorComponentSummmon(undefined8 param_1)

{
  ...
  func_0x018ac3cc(&uStack_40,&"ActorComponentSummmon",&uStack_50,0x736d101);
  uVar3 = func_0x018abfd4(&uStack_40,&"dieSyncCaller",&UNK_018ac1bc,0,&UNK_018ac1c4,0);
  puVar4 = (undefined8 *)func_0x018ac1cc(uVar3,&"createTime",&UNK_018ac3b4,0,&UNK_018ac3bc,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_018ac3c4;
  func_0x0124ec90(*puVar4,&UNK_018acbfc,1);
  ...
  func_0x0124f120(uVar3,&"createSkill");
