...
void case52_SkillComboLevelResObject(undefined8 param_1)

{
  ...
  func_0x0176b740(&uStack_40,&"SkillComboLevelResObject",&uStack_50,0x736d101);
  uVar3 = func_0x0176b510(&uStack_40,&"levelID",&UNK_0176b6f8,0,&UNK_0176b700,0);
  puVar4 = (undefined8 *)func_0x0176b510(uVar3,&"igConfigID",&UNK_0176b708,0,&UNK_0176b710,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_0176b718;
  func_0x0124ec90(*puVar4,&UNK_0176bd24,1);
  ...
  func_0x0124f120(uVar3,&"replayFlowPath");
  ...
  func_0x0124e060(uVar3,uVar2);
  func_0x0124c4d0(uVar3,0xfffffffd);
  uVar3 = func_0x0176b510(puVar4,&"replayCutTimeAtStart",&UNK_0176b720,0,&UNK_0176b728,0);
  puVar4 = (undefined8 *)func_0x0176b510(uVar3,&"replayCutTimeAtEnd",&UNK_0176b730,0,&UNK_0176b738,0);
