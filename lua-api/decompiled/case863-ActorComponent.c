...
void case863_ActorComponent(undefined8 param_1)

{
  ...
  func_0x01a082f0(&uStack_30,&"ActorComponent",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01a080f0;
  func_0x0124ec90(uStack_30,&UNK_01a086b4,1);
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x01a080f8(&uStack_30,&"profilerTypeIndex",&UNK_01a082e0,0,&UNK_01a082e8,0);
