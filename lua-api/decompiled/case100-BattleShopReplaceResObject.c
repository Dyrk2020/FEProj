...
void case100_BattleShopReplaceResObject(undefined8 param_1)

{
  ...
  func_0x01787d3c(&uStack_40,&"BattleShopReplaceResObject",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x01787b3c(&uStack_40,&"replaceModeId",&UNK_01787d24,0,&UNK_01787d2c,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01787d34;
  func_0x0124ec90(*puVar3,&UNK_01788320,1);
  ...
  func_0x0124f120(uVar5,&"replaceEquipArray");
