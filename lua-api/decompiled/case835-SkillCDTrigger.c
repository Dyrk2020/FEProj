...
void case835_SkillCDTrigger(undefined8 param_1)

{
  ...
  func_0x019da374(&uStack_30,&"SkillCDTrigger",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_019d9f7c;
  func_0x0124ec90(uStack_30,&UNK_019da738,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x019d9f84(&uStack_30,&"rpn1",&UNK_019da16c,0,0,0);
  uVar4 = func_0x019d9f84(uVar4,&"rpn2",&UNK_019da174,0,0,0);
  puVar3 = (undefined8 *)func_0x019da17c(uVar4,&"lastReduceCD",&UNK_019da364,0,&UNK_019da36c,0);
