...
void case139_SummonReplaceEntry(undefined8 param_1)

{
  ...
  func_0x0179a9c8(&uStack_30,&"SummonReplaceEntry",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0179a9c0;
  func_0x0124ec90(uStack_30,&UNK_0179ad8c,1);
