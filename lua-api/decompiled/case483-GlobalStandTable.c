...
void case483_GlobalStandTable(undefined8 param_1)

{
  ...
  func_0x018823d4(&uStack_30,&"GlobalStandTable",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_01881fac;
  func_0x0124ec90(uStack_30,&UNK_01882798,1);
  ...
  func_0x0124f120(uVar4,&"elementalFlagTable");
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x01881fb4(&uStack_30,&"maxRow",&UNK_0188219c,0,&UNK_018821a4,0);
  uVar4 = func_0x01881fb4(uVar4,&"maxCol",&UNK_018821ac,0,&UNK_018821b4,0);
  puVar3 = (undefined8 *)func_0x018821bc(uVar4,&"origin",&UNK_018823a4,0,&UNK_018823b8,0);
