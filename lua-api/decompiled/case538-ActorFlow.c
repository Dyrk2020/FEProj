...
void case538_ActorFlow(undefined8 param_1)

{
  ...
  func_0x018b8d08(&uStack_30,&"ActorFlow",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018b8b08;
  func_0x0124ec90(uStack_30,&UNK_018b90cc,1);
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x018b8b10(&uStack_30,&"isEvolve",&UNK_018b8cf8,0,&UNK_018b8d00,0);
