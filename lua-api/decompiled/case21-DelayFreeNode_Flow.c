...
void case21_DelayFreeNode_Flow(undefined8 param_1)

{
  ...
  func_0x01759c50(&uStack_40,&"DelayFreeNode_Flow",&uStack_50,0x736d101);
  uVar3 = func_0x01759a40(&uStack_40,&"startTime",&UNK_01759c28,0,&UNK_01759c30,0);
  puVar4 = (undefined8 *)func_0x01759a40(uVar3,&"delayTime",&UNK_01759c38,0,&UNK_01759c40,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_01759c48;
  func_0x0124ec90(*puVar4,&UNK_0175a260,1);
