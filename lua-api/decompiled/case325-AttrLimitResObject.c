...
void case325_AttrLimitResObject(undefined8 param_1)

{
  ...
  func_0x018009f4(&uStack_30,&"AttrLimitResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018009ec;
  func_0x0124ec90(uStack_30,&UNK_01800db8,1);
