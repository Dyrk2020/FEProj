...
void case815_SkinFlowAction(undefined8 param_1)

{
  ...
  func_0x019c418c(&uStack_40,&"SkinFlowAction",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x019c3d94(&uStack_40,&"flowObjId",&UNK_019c3f7c,0,&UNK_019c3f84,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019c3f8c;
  func_0x0124ec90(*puVar3,&UNK_019c4770,1);
  ...
  func_0x0124f120(uVar5,&"fieldInfos");
  ...
  func_0x0124e060(uVar5,uVar2);
  func_0x0124c4d0(uVar5,0xfffffffd);
  puVar3 = (undefined8 *)func_0x019c3f94(puVar3,&"discardInSkin",&UNK_019c417c,0,&UNK_019c4184,0);
