...
void case768_BulletFlow(undefined8 param_1)

{
  ...
  func_0x0199d96c(&uStack_40,&"BulletFlow",&uStack_50,0x736d101);
  uVar3 = func_0x0199d55c(&uStack_40,&"stopBulletOnFlowLeave",&UNK_0199d744,0,&UNK_0199d74c,0);
  uVar3 = func_0x0199d55c(uVar3,&"firstTickDeltaTime",&UNK_0199d754,0,&UNK_0199d75c,0);
  uVar3 = func_0x0199d764(uVar3,&"bulletTarget",&UNK_0199d94c,0,0,0);
  uVar3 = func_0x0199d764(uVar3,&"bulletCaster",&UNK_0199d954,0,0,0);
  puVar4 = (undefined8 *)func_0x0199d764(uVar3,&"bulletHiter",&UNK_0199d95c,0,0,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_0199d964;
  func_0x0124ec90(*puVar4,&UNK_0199e1c4,1);
  ...
  func_0x0124f120(uVar3,&"shareBullet");
