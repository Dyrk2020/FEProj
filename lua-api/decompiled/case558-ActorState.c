...
void case558_ActorState(undefined8 param_1)

{
  ...
  func_0x018cad48(&uStack_40,&"ActorState",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x018cab34(&uStack_40,&"stateId",&UNK_018cad1c,0,&UNK_018cad24,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018cad40;
  func_0x0124ec90(*puVar3,&UNK_018cb494,1);
