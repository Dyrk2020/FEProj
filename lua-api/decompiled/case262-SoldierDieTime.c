...
void case262_SoldierDieTime(undefined8 param_1)

{
  ...
  func_0x017de6c8(&uStack_30,&"SoldierDieTime",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017de4c8;
  func_0x0124ec90(uStack_30,&UNK_017dea8c,1);
  ...
  func_0x0124f120(uVar2,&"soldierId");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x017de4d0(&uStack_30,&"dieTime",&UNK_017de6b8,0,&UNK_017de6c0,0);
