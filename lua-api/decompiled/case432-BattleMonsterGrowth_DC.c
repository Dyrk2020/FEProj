...
void case432_BattleMonsterGrowth_DC(undefined8 param_1)

{
  ...
  func_0x018634e0(&uStack_30,&"BattleMonsterGrowth_DC",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018634d8;
  func_0x0124ec90(uStack_30,&UNK_018638a4,1);
  ...
  func_0x0124f120(uVar1,&"monsterGrowthDict");
