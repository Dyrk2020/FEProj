...
void case541_SkillCDMgr(undefined8 param_1)

{
  ...
  func_0x018bb744(&uStack_30,&"SkillCDMgr",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018bb53c;
  func_0x0124ec90(uStack_30,&UNK_018bbb08,1);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_018bb544;
  func_0x0124ec90(uStack_30,&UNK_018bbc2c,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar2 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar2,0xfffffffe);
  uVar3 = func_0x0124e920(uVar2,0xfffffffe);
  func_0x0124f120(uVar2,&"nodeList");
  func_0x0124cfc0(uVar2,0xfffffffe,1);
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  uVar2 = uStack_30;
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x018bb54c(&uStack_30,&"cdSpeed",&UNK_018bb734,0,&UNK_018bb73c,0);
