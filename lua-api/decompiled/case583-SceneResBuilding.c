...
void case583_SceneResBuilding(undefined8 param_1)

{
  ...
  func_0x018e7c68(&uStack_30,&"SceneResBuilding",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018e7c60;
  func_0x0124ec90(uStack_30,&UNK_018e802c,1);
