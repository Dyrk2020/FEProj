...
void case844_SkillSlotStrengthenInfo(undefined8 param_1)

{
  ...
  func_0x019e1f48(&uStack_30,&"SkillSlotStrengthenInfo",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019e1d48;
  func_0x0124ec90(uStack_30,&UNK_019e230c,1);
  ...
  func_0x0124f120(uVar2,&"relateInfos");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x019e1d50(&uStack_30,&"whiteGemStrengthenID",&UNK_019e1f38,0,&UNK_019e1f40,0);
