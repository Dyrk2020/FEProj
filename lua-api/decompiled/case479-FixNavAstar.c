...
void case479_FixNavAstar(undefined8 param_1)

{
  ...
  func_0x0187f97c(&uStack_40,&"FixNavAstar",&uStack_50,0x736d101);
  uVar3 = func_0x0187f76c(&uStack_40,&"openedValue",&UNK_0187f954,0,&UNK_0187f95c,0);
  puVar4 = (undefined8 *)func_0x0187f76c(uVar3,&"closedValue",&UNK_0187f964,0,&UNK_0187f96c,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_0187f974;
  func_0x0124ec90(*puVar4,&UNK_0187ff60,1);
  ...
  func_0x0124f120(uVar3,&"variableTable");
