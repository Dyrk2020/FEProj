...
void case458_PointPathData(undefined8 param_1)

{
  ...
  func_0x0187111c(&uStack_30,&"PointPathData",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01870f1c;
  func_0x0124ec90(uStack_30,&UNK_018714e0,1);
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x01870f24(&uStack_30,&"line",&UNK_0187110c,0,&UNK_01871114,0);
