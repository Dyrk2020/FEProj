...
void case836_CustomInterruptInfo(undefined8 param_1)

{
  ...
  func_0x019daf3c(&uStack_40,&"CustomInterruptInfo",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x019dad1c(&uStack_40,&"customType",&UNK_019daf04,0,&UNK_019daf0c,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019daf14;
  func_0x0124ec90(*puVar3,&UNK_019db520,1);
  ...
  func_0x0124e060(uVar5,uVar2);
  func_0x0124c4d0(uVar5,0xfffffffd);
  uVar5 = func_0x019dad1c(puVar3,&"slotIndex",&UNK_019daf1c,0,&UNK_019daf24,0);
  puVar3 = (undefined8 *)func_0x019dad1c(uVar5,&"relation",&UNK_019daf2c,0,&UNK_019daf34,0);
