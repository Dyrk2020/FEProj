...
void case494_EvacuateDataMgr(undefined8 param_1)

{
  ...
  func_0x0188c2b4(&uStack_30,&"EvacuateDataMgr",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0188c0b4;
  func_0x0124ec90(uStack_30,&UNK_0188c678,1);
  ...
  func_0x0124f120(uVar2,&"clientSetFlag");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x0188c0bc(&uStack_30,&"uniqueID",&UNK_0188c2a4,0,&UNK_0188c2ac,0);
