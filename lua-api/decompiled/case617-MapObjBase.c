...
void case617_MapObjBase(undefined8 param_1)

{
  ...
  func_0x018fe420(&uStack_40,&"MapObjBase",&uStack_50,0x736d101);
  uVar3 = func_0x018fdfb8(&uStack_40,&"id",&UNK_018fe1a0,0,&UNK_018fe1a8,0);
  uVar3 = func_0x018fe1b0(uVar3,&"position",&UNK_018fe398,0,&UNK_018fe3ac,0);
  uVar3 = func_0x018fe1b0(uVar3,&"forward",&UNK_018fe3c8,0,&UNK_018fe3dc,0);
  uVar3 = func_0x018fdfb8(uVar3,&"mapObjType",&UNK_018fe3f8,0,&UNK_018fe400,0);
  puVar4 = (undefined8 *)func_0x018fdfb8(uVar3,&"campType",&UNK_018fe408,0,&UNK_018fe410,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_018fe418;
  func_0x0124ec90(*puVar4,&UNK_018fec9c,1);
  ...
  func_0x0124f120(uVar3,&"nodeName");
