...
void case33_BattleLiteFowCutMgr(undefined8 param_1)

{
  ...
  func_0x01760294(&uStack_30,&"BattleLiteFowCutMgr",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0176028c;
  func_0x0124ec90(uStack_30,&UNK_01760658,1);
  ...
  func_0x0124f120(uVar1,&"focusPlayer");
