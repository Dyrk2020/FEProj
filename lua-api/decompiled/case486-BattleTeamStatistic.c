...
void case486_BattleTeamStatistic(undefined8 param_1)

{
  ...
  func_0x01884e7c(&uStack_30,&"BattleTeamStatistic",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01884c68;
  func_0x0124ec90(uStack_30,&UNK_01885240,1);
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x01884c70(&uStack_30,&"totalGenerateSoldiers",&UNK_01884e58,0,&UNK_01884e60,0);
