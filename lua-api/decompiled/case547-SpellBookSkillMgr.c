...
void case547_SpellBookSkillMgr(undefined8 param_1)

{
  ...
  func_0x018bfa20(&uStack_40,&"SpellBookSkillMgr",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_40,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_018bf5e8;
  func_0x0124ec90(uStack_40,&UNK_018bfde4,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x018bf5f0(&uStack_40,&"currentUSBSkillID",&UNK_018bf7d8,0,&UNK_018bf7e0,0);
  puVar3 = (undefined8 *)func_0x018bf7fc(uVar4,&"bucketHandle",&UNK_018bf9e4,0,&UNK_018bf9ec,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_018bfa08;
  func_0x0124ec90(*puVar3,&UNK_018c05a8,1);
  func_0x0124c0c0(*puVar3,0xffffffff);
  uVar4 = *puVar3;
  func_0x0124a650(uVar4,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar4,0xfffffffe);
  uVar2 = func_0x0124e920(uVar4,0xfffffffe);
  func_0x0124f120(uVar4,&"matHandlerBuff");
  func_0x0124cfc0(uVar4,0xfffffffe,1);
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = *puVar3;
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  puVar3 = (undefined8 *)func_0x018bf5f0(puVar3,&"matHandlerBuffID",&UNK_018bfa10,0,&UNK_018bfa18,0);
