...
void case854_ActorBulletEmitter(undefined8 param_1)

{
  ...
  func_0x01a02360(&uStack_30,&"ActorBulletEmitter",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01a02358;
  func_0x0124ec90(uStack_30,&UNK_01a02724,1);
