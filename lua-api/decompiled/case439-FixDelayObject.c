...
void case439_FixDelayObject(undefined8 param_1)

{
  ...
  func_0x01866ba8(&uStack_30,&"FixDelayObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018669a8;
  func_0x0124ec90(uStack_30,&UNK_01866f6c,1);
  ...
  func_0x0124f120(uVar2,&"fixObject");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x018669b0(&uStack_30,&"delayTime",&UNK_01866b98,0,&UNK_01866ba0,0);
