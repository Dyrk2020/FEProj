...
void case94_CherryRoundResObject(undefined8 param_1)

{
  ...
  func_0x01784ddc(&uStack_30,&"CherryRoundResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01784dd4;
  func_0x0124ec90(uStack_30,&UNK_017851a0,1);
  ...
  func_0x0124f120(uVar1,&"cherryRoundDataList");
