...
void case758_HatredStateFSM(undefined8 param_1)

{
  ...
  func_0x0198f230(&uStack_30,&"HatredStateFSM",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0198f014;
  func_0x0124ec90(uStack_30,&UNK_0198f5f4,1);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_0198f01c;
  func_0x0124ec90(uStack_30,&UNK_0198f718,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar2 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar2,0xfffffffe);
  uVar3 = func_0x0124e920(uVar2,0xfffffffe);
  func_0x0124f120(uVar2,&"currentState");
  func_0x0124cfc0(uVar2,0xfffffffe,1);
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  uVar2 = uStack_30;
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x0198f024(&uStack_30,&"isOutLeashZone",&UNK_0198f20c,0,&UNK_0198f214,0);
