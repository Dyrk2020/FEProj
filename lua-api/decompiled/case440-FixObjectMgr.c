...
void case440_FixObjectMgr(undefined8 param_1)

{
  ...
  func_0x018674dc(&uStack_40,&"FixObjectMgr",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x018672dc(&uStack_40,&"listObjectsCount",&UNK_018674c4,0,&UNK_018674cc,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018674d4;
  func_0x0124ec90(*puVar3,&UNK_01867ac0,1);
  ...
  func_0x0124f120(uVar5,&"delayPool");
