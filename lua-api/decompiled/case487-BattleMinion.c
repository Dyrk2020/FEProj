...
void case487_BattleMinion(undefined8 param_1)

{
  ...
  func_0x018858fc(&uStack_40,&"BattleMinion",&uStack_50,0x736d101);
  uVar3 = func_0x018856ec(&uStack_40,&"soldierQuickState",&UNK_018858d4,0,&UNK_018858dc,0);
  puVar4 = (undefined8 *)func_0x018856ec(uVar3,&"soldierQuickOver",&UNK_018858e4,0,&UNK_018858ec,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_018858f4;
  func_0x0124ec90(*puVar4,&UNK_01885ee0,1);
