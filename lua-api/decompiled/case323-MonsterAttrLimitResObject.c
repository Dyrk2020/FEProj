...
void case323_MonsterAttrLimitResObject(undefined8 param_1)

{
  ...
  func_0x017ffcec(&uStack_30,&"MonsterAttrLimitResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017ffce4;
  func_0x0124ec90(uStack_30,&UNK_018000b0,1);
  ...
  func_0x0124f120(uVar1,&"limitAttrs");
