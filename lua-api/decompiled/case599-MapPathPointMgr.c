...
void case599_MapPathPointMgr(undefined8 param_1)

{
  ...
  func_0x018f0ecc(&uStack_30,&"MapPathPointMgr",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018f0ec4;
  func_0x0124ec90(uStack_30,&UNK_018f1290,1);
  ...
  func_0x0124f120(uVar1,&"mapPointPathList");
