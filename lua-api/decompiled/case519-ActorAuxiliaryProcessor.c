...
void case519_ActorAuxiliaryProcessor(undefined8 param_1)

{
  ...
  func_0x018a9bf4(&uStack_30,&"ActorAuxiliaryProcessor",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018a9bec;
  func_0x0124ec90(uStack_30,&UNK_018a9fb8,1);
