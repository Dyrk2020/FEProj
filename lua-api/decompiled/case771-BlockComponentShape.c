...
void case771_BlockComponentShape(undefined8 param_1)

{
  ...
  func_0x019a04a4(&uStack_40,&"BlockComponentShape",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x019a02a4(&uStack_40,&"lastSyncId",&UNK_019a048c,0,&UNK_019a0494,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019a049c;
  func_0x0124ec90(*puVar3,&UNK_019a0a88,1);
