...
void case55_ForgeCoreCardResObject(undefined8 param_1)

{
  ...
  func_0x0176cd5c(&uStack_40,&"ForgeCoreCardResObject",&uStack_50,0x736d101);
  uVar3 = func_0x0176c954(&uStack_40,&"allowRepeat",&UNK_0176cb3c,0,&UNK_0176cb44,0);
  uVar3 = func_0x0176cb4c(uVar3,&"unlockLayer",&UNK_0176cd34,0,&UNK_0176cd3c,0);
  puVar4 = (undefined8 *)func_0x0176cb4c(uVar3,&"minimumGap",&UNK_0176cd44,0,&UNK_0176cd4c,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_0176cd54;
  func_0x0124ec90(*puVar4,&UNK_0176d560,1);
