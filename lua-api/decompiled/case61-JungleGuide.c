...
void case61_JungleGuide(undefined8 param_1)

{
  ...
  func_0x01772d24(&uStack_30,&"JungleGuide",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01772d1c;
  func_0x0124ec90(uStack_30,&UNK_017730e8,1);
