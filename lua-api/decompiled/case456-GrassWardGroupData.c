...
void case456_GrassWardGroupData(undefined8 param_1)

{
  ...
  func_0x01870324(&uStack_40,&"GrassWardGroupData",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x01870124(&uStack_40,&"groupID",&UNK_0187030c,0,&UNK_01870314,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0187031c;
  func_0x0124ec90(*puVar3,&UNK_01870908,1);
  ...
  func_0x0124f120(uVar5,&"grassWards");
