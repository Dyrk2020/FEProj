...
void case598_MapPathPointObj(undefined8 param_1)

{
  ...
  func_0x018f07bc(&uStack_30,&"MapPathPointObj",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018f05bc;
  func_0x0124ec90(uStack_30,&UNK_018f0b80,1);
  ...
  func_0x0124f120(uVar2,&"pathPointPos");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x018f05c4(&uStack_30,&"line",&UNK_018f07ac,0,&UNK_018f07b4,0);
