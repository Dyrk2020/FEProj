...
void case333_CmdMgr(undefined8 param_1)

{
  ...
  func_0x01810cb0(&uStack_30,&"CmdMgr",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01810ca8;
  func_0x0124ec90(uStack_30,&UNK_01811074,1);
