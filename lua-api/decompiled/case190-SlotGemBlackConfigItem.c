...
void case190_SlotGemBlackConfigItem(undefined8 param_1)

{
  ...
  func_0x017b6244(&uStack_30,&"SlotGemBlackConfigItem",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017b623c;
  func_0x0124ec90(uStack_30,&UNK_017b6608,1);
