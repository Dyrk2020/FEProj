...
void case470_GamePlayComponentRefResObject(undefined8 param_1)

{
  ...
  func_0x0187840c(&uStack_30,&"GamePlayComponentRefResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0187820c;
  func_0x0124ec90(uStack_30,&UNK_018787d0,1);
  ...
  func_0x0124f120(uVar2,&"compAsset");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x01878214(&uStack_30,&"lazyAttach",&UNK_018783fc,0,&UNK_01878404,0);
