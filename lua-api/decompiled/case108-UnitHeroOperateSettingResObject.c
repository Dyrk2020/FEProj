...
void case108_UnitHeroOperateSettingResObject(undefined8 param_1)

{
  ...
  func_0x0178afa4(&uStack_30,&"UnitHeroOperateSettingResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0178af9c;
  func_0x0124ec90(uStack_30,&UNK_0178b368,1);
  ...
  func_0x0124f120(uVar1,&"unitHeroOperateSettingList");
