...
void case64_RuinWaveSkillDataResObject(undefined8 param_1)

{
  ...
  func_0x01773ee0(&uStack_30,&"RuinWaveSkillDataResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01773ed8;
  func_0x0124ec90(uStack_30,&UNK_017742a4,1);
  ...
  func_0x0124f120(uVar1,&"ruinWaveSkillDataList");
