...
void case610_MapAnchorComponent(undefined8 param_1)

{
  ...
  func_0x018fa130(&uStack_30,&"MapAnchorComponent",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018fa128;
  func_0x0124ec90(uStack_30,&UNK_018fa4f4,1);
