...
void case179_AFKResObject(undefined8 param_1)

{
  ...
  func_0x017b07bc(&uStack_30,&"AFKResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017b07b4;
  func_0x0124ec90(uStack_30,&UNK_017b0b80,1);
  ...
  func_0x0124f120(uVar1,&"afkConfigResObjectList");
