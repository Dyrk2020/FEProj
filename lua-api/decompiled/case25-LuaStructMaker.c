// ===== case25-LuaStructMaker @ 01690690 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case25-LuaStructMaker
...

{
  ...
  func_0x0175be74(&uStack_40,&"LuaStructMaker",&uStack_50,0x736d101);
  uVar3 = func_0x0175bc64(&uStack_40,&"typeUseIndex",&UNK_0175be4c,0,&UNK_0175be54,0);
  puVar4 = (undefined8 *)func_0x0175bc64(uVar3,&"structAllocIndex",&UNK_0175be5c,0,&UNK_0175be64,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_0175be6c;
  func_0x0124ec90(*puVar4,&UNK_0175c458,1);
  ...
  func_0x0124f120(uVar3,&"structMap");
