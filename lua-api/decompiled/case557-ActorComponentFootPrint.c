...
void case557_ActorComponentFootPrint(undefined8 param_1)

{
  ...
  func_0x018ca42c(&uStack_30,&"ActorComponentFootPrint",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018ca22c;
  func_0x0124ec90(uStack_30,&UNK_018ca7f0,1);
  ...
  func_0x0124f120(uVar2,&"cachedTile");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x018ca234(&uStack_30,&"cachedTileIdx",&UNK_018ca41c,0,&UNK_018ca424,0);
