...
void case68_RuinSkillRandomResObject(undefined8 param_1)

{
  ...
  func_0x017756e8(&uStack_30,&"RuinSkillRandomResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017756e0;
  func_0x0124ec90(uStack_30,&UNK_01775aac,1);
  ...
  func_0x0124f120(uVar1,&"ruinSkillRandomDataList");
