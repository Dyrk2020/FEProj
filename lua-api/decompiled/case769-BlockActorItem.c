...
void case769_BlockActorItem(undefined8 param_1)

{
  ...
  func_0x0199e608(&uStack_30,&"BlockActorItem",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_0199e2e8;
  func_0x0124ec90(uStack_30,&UNK_0199e9cc,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x0199e2f0(&uStack_30,&"filterType",&UNK_0199e4d8,0,&UNK_0199e4e0,0);
  puVar3 = (undefined8 *)func_0x0199e2f0(uVar4,&"battleActorId",&UNK_0199e570,0,&UNK_0199e578,0);
