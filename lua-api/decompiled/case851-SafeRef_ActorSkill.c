// ===== case851-SafeRef_ActorSkill @ 01740134 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case851-SafeRef_ActorSkill


void case851_SafeRef_ActorSkill(undefined8 param_1)

{
  ...
  func_0x019f2b6c(&uStack_30,&"SafeRef_ActorSkill",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019f2958;
  func_0x0124ec90(uStack_30,&UNK_019f2f30,1);
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x019f2960(&uStack_30,&"age",&UNK_019f2b48,0,&UNK_019f2b50,0);
