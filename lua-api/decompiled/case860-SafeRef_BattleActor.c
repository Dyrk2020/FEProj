// ===== case860-SafeRef_BattleActor @ 01743434 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case860-SafeRef_BattleActor


void case860_SafeRef_BattleActor(undefined8 param_1)

{
  ...
  func_0x01a06358(&uStack_30,&"SafeRef_BattleActor",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01a06144;
  func_0x0124ec90(uStack_30,&UNK_01a0671c,1);
  ...
  func_0x0124f120(uVar2,&"reference");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x01a0614c(&uStack_30,&"age",&UNK_01a06334,0,&UNK_01a0633c,0);
