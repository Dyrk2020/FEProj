...
void case821_HeroComponentReflectMgr(undefined8 param_1)

{
  ...
  func_0x019c8be0(&uStack_40,&"HeroComponentReflectMgr",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_40,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_019c8764;
  func_0x0124ec90(uStack_40,&UNK_019c8fa4,1);
  ...
  func_0x0124f120(uVar4,&"skillVarReflectSkillDataList");
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x019c876c(&uStack_40,&"damageFixParam",&UNK_019c8954,0,&UNK_019c895c,0);
  uVar4 = func_0x019c89bc(uVar4,&"damageType",&UNK_019c8ba4,0,&UNK_019c8bac,0);
  puVar3 = (undefined8 *)func_0x019c89bc(uVar4,&"damageVarSkillID",&UNK_019c8bc8,0,&UNK_019c8bd0,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_019c8bd8;
  func_0x0124ec90(*puVar3,&UNK_019c9804,1);
  func_0x0124c0c0(*puVar3,0xffffffff);
  uVar4 = *puVar3;
  func_0x0124a650(uVar4,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar4,0xfffffffe);
  uVar2 = func_0x0124e920(uVar4,0xfffffffe);
  func_0x0124f120(uVar4,&"reflectShaderDataList");
  func_0x0124cfc0(uVar4,0xfffffffe,1);
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = *puVar3;
