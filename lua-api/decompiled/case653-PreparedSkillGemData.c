// ===== case653-PreparedSkillGemData @ 01715364 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case653-PreparedSkillGemData


void case653_PreparedSkillGemData(undefined8 param_1)

{
  ...
  func_0x01929cac(&uStack_30,&"PreparedSkillGemData",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01929ca4;
  func_0x0124ec90(uStack_30,&UNK_0192a070,1);
  ...
  func_0x0124f120(uVar1,&"preparedGemDatas");
