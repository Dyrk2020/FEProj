...
void case568_MapGateManager(undefined8 param_1)

{
  ...
  func_0x018de0ac(&uStack_30,&"MapGateManager",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018de0a4;
  func_0x0124ec90(uStack_30,&UNK_018de470,1);
  ...
  func_0x0124f120(uVar1,&"gateInfos");
