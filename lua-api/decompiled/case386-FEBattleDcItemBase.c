...
void case386_FEBattleDcItemBase(undefined8 param_1)

{
  ...
  func_0x01839f9c(&uStack_30,&"FEBattleDcItemBase",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_01839ba4;
  func_0x0124ec90(uStack_30,&UNK_0183a360,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x01839bac(&uStack_30,&"battleBeginTime",&UNK_01839d94,0,&UNK_01839d9c,0);
  puVar3 = (undefined8 *)func_0x01839da4(uVar4,&"reportTypesCount",&UNK_01839f8c,0,&UNK_01839f94,0);
