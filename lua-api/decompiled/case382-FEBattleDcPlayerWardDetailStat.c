...
void case382_FEBattleDcPlayerWardDetailStat(undefined8 param_1)

{
  ...
  func_0x018376c0(&uStack_40,&"FEBattleDcPlayerWardDetailStat",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x018374c0(&uStack_40,&"platformType",&UNK_018376a8,0,&UNK_018376b0,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018376b8;
  func_0x0124ec90(*puVar3,&UNK_01837ca4,1);
  ...
  func_0x0124f120(uVar5,&"wardActors");
