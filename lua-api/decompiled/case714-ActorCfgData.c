...
void case714_ActorCfgData(undefined8 param_1)

{
  ...
  func_0x0196e1fc(&uStack_40,&"ActorCfgData",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0196defc(&uStack_40,&"block",&UNK_0196e0e4,0,&UNK_0196e1b0,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0196e1f4;
  func_0x0124ec90(*puVar3,&UNK_0196f3c4,1);
