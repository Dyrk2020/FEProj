...
void case84_ChampionSpellBookCareerTagResObject(undefined8 param_1)

{
  ...
  func_0x0177faa0(&uStack_30,&"ChampionSpellBookCareerTagResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0177fa98;
  func_0x0124ec90(uStack_30,&UNK_0177fe64,1);
