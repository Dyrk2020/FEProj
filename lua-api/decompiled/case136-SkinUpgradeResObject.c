...
void case136_SkinUpgradeResObject(undefined8 param_1)

{
  ...
  func_0x017998a0(&uStack_30,&"SkinUpgradeResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01799898;
  func_0x0124ec90(uStack_30,&UNK_01799c64,1);
