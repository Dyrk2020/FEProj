...
void case75_MonsterBehaviorLevelExpressionConfig(undefined8 param_1)

{
  ...
  func_0x01779674(&uStack_40,&"MonsterBehaviorLevelExpressionConfig",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x01779474(&uStack_40,&"nodeId",&UNK_0177965c,0,&UNK_01779664,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0177966c;
  func_0x0124ec90(*puVar3,&UNK_01779c58,1);
  ...
  func_0x0124f120(uVar5,&"expressionPath");
