...
void case319_HeroSkillLvUpRuleResObject(undefined8 param_1)

{
  ...
  func_0x017fe5b0(&uStack_30,&"HeroSkillLvUpRuleResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017fe5a8;
  func_0x0124ec90(uStack_30,&UNK_017fe974,1);
  ...
  func_0x0124f120(uVar1,&"lvRuleData");
