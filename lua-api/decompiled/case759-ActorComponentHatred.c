...
void case759_ActorComponentHatred(undefined8 param_1)

{
  ...
  func_0x0198fdc4(&uStack_40,&"ActorComponentHatred",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0198fbc4(&uStack_40,&"latestHurtTime",&UNK_0198fdac,0,&UNK_0198fdb4,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0198fdbc;
  func_0x0124ec90(*puVar3,&UNK_019903d4,1);
  ...
  func_0x0124f120(uVar5,&"diveTower");
