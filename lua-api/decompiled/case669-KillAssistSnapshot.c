...
void case669_KillAssistSnapshot(undefined8 param_1)

{
  ...
  func_0x0193c158(&uStack_40,&"KillAssistSnapshot",&uStack_50,0x736d101);
  uVar3 = func_0x0193bd50(&uStack_40,&"snapTime",&UNK_0193bf38,0,&UNK_0193bf40,0);
  uVar3 = func_0x0193bf48(uVar3,&"killerRoleId",&UNK_0193c130,0,&UNK_0193c138,0);
  puVar4 = (undefined8 *)func_0x0193bf48(uVar3,&"deadRoleId",&UNK_0193c140,0,&UNK_0193c148,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_0193c150;
  func_0x0124ec90(*puVar4,&UNK_0193c988,1);
  ...
  func_0x0124f120(uVar3,&"assistSnapshots");
