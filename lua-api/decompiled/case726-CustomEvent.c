// ===== case726-CustomEvent @ 01725014 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case726-CustomEvent


void case726_CustomEvent(undefined8 param_1)

{
  ...
  func_0x01977a18(&uStack_40,&"CustomEvent",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x01977818(&uStack_40,&"id",&UNK_01977a00,0,&UNK_01977a08,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01977a10;
  func_0x0124ec90(*puVar3,&UNK_01977ffc,1);
