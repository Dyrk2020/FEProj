...
void case232_GainWeightTable(undefined8 param_1)

{
  ...
  func_0x017cb6e8(&uStack_30,&"GainWeightTable",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017cb4e8;
  func_0x0124ec90(uStack_30,&UNK_017cbaac,1);
  ...
  func_0x0124f120(uVar2,&"gainWeightItems");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x017cb4f0(&uStack_30,&"totalWeight",&UNK_017cb6d8,0,&UNK_017cb6e0,0);
