...
void case481_MapPolygon(undefined8 param_1)

{
  ...
  func_0x01880cbc(&uStack_30,&"MapPolygon",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_0188089c;
  func_0x0124ec90(uStack_30,&UNK_01881080,1);
  ...
  func_0x0124f120(uVar4,&"vertices");
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x018808a4(&uStack_30,&"aabb",&UNK_01880a8c,0,&UNK_01880aa0,0);
  puVar3 = (undefined8 *)func_0x01880ac4(uVar4,&"verticeCount",&UNK_01880cac,0,&UNK_01880cb4,0);
