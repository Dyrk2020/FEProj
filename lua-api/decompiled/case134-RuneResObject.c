...
void case134_RuneResObject(undefined8 param_1)

{
  ...
  func_0x01798994(&uStack_40,&"RuneResObject",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x01798794(&uStack_40,&"type",&UNK_0179897c,0,&UNK_01798984,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0179898c;
  func_0x0124ec90(*puVar3,&UNK_01798f78,1);
  ...
  func_0x0124f120(uVar5,&"staticDataList");
