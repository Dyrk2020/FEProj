// ===== case603-SimpleAnchorLevelData @ 01708478 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case603-SimpleAnchorLevelData


void case603_SimpleAnchorLevelData(undefined8 param_1)

{
  ...
  func_0x018f5150(&uStack_40,&"SimpleAnchorLevelData",&uStack_50,0x736d101);
  uVar3 = func_0x018f4f50(&uStack_40,&"positionList",&UNK_018f5138,0,0,0);
  puVar4 = (undefined8 *)func_0x018f4f50(uVar3,&"forwardList",&UNK_018f5140,0,0,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_018f5148;
  func_0x0124ec90(*puVar4,&UNK_018f5788,1);
  ...
  func_0x0124f120(uVar3,&"childAnchorGroupNameList");
