...
void case750_BattleActor_DC(undefined8 param_1)

{
  ...
  func_0x0198a108(&uStack_30,&"BattleActor_DC",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_01989f08;
  func_0x0124ec90(uStack_30,&UNK_0198a4cc,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x01989f10(&uStack_30,&"cfgData",&UNK_0198a0f8,0,0,0);
  puVar3 = (undefined8 *)func_0x01989f10(uVar4,&"originData",&UNK_0198a100,0,0,0);
