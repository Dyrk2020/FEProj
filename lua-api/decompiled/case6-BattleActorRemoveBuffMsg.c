// ===== case6-BattleActorRemoveBuffMsg @ 0168db18 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case6-BattleActorRemoveBuffMsg


void case6_BattleActorRemoveBuffMsg(undefined8 param_1)

{
  ...
  func_0x01752c70(&uStack_30,&"BattleActorRemoveBuffMsg",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01752c54;
  func_0x0124ec90(uStack_30,&UNK_01753034,1);
