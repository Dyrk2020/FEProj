...
void case103_FutureToggleSwitchResObject(undefined8 param_1)

{
  ...
  func_0x01789084(&uStack_30,&"FutureToggleSwitchResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0178907c;
  func_0x0124ec90(uStack_30,&UNK_01789448,1);
  ...
  func_0x0124f120(uVar1,&"versionSwitchs");
