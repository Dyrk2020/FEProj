...
void case284_WardSkillResObject(undefined8 param_1)

{
  ...
  func_0x017eb14c(&uStack_30,&"WardSkillResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017eb144;
  func_0x0124ec90(uStack_30,&UNK_017eb510,1);
  ...
  func_0x0124f120(uVar1,&"variantSkillAssets");
