...
void case862_ActorComponentHelpMarker(undefined8 param_1)

{
  ...
  func_0x01a07c08(&uStack_30,&"ActorComponentHelpMarker",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01a07c00;
  func_0x0124ec90(uStack_30,&UNK_01a07fcc,1);
  ...
  func_0x0124f120(uVar1,&"markerInfoList");
