...
void case634_BattlePlayerWardData(undefined8 param_1)

{
  ...
  func_0x0190f664(&uStack_30,&"BattlePlayerWardData",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0190f40c;
  func_0x0124ec90(uStack_30,&UNK_0190fa28,1);
  ...
  func_0x0124f120(uVar2,&"wardInfo");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x0190f414(&uStack_30,&"totalScore",&UNK_0190f5fc,0,&UNK_0190f604,0);
