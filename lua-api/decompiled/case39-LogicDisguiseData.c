// ===== case39-LogicDisguiseData @ 0169318c =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case39-LogicDisguiseData


void case39_LogicDisguiseData(undefined8 param_1)

{
  ...
  func_0x01764e98(&uStack_40,&"LogicDisguiseData",&uStack_50,0x736d101);
  uVar3 = func_0x01764c88(&uStack_40,&"DisguiseID",&UNK_01764e70,0,&UNK_01764e78,0);
  puVar4 = (undefined8 *)func_0x01764c88(uVar3,&"DisguiseType",&UNK_01764e80,0,&UNK_01764e88,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_01764e90;
  func_0x0124ec90(*puVar4,&UNK_0176547c,1);
  ...
  func_0x0124f120(uVar3,&"intParmValueList");
