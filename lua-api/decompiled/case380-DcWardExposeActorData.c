...
void case380_DcWardExposeActorData(undefined8 param_1)

{
  ...
  func_0x01835a48(&uStack_30,&"DcWardExposeActorData",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_01835640;
  func_0x0124ec90(uStack_30,&UNK_01835e0c,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x01835648(&uStack_30,&"enterTime",&UNK_01835830,0,&UNK_01835838,0);
  uVar4 = func_0x01835648(uVar4,&"exitTime",&UNK_01835840,0,&UNK_01835848,0);
  puVar3 = (undefined8 *)func_0x01835850(uVar4,&"isLeave",&UNK_01835a38,0,&UNK_01835a40,0);
