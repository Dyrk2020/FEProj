...
void case303_AICtrlCfgResObject(undefined8 param_1)

{
  ...
  func_0x017f70ec(&uStack_30,&"AICtrlCfgResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017f70e4;
  func_0x0124ec90(uStack_30,&UNK_017f74b0,1);
  ...
  func_0x0124f120(uVar1,&"aiCtrlCfgList");
