...
void case435_TestingMgr(undefined8 param_1)

{
  ...
  func_0x01864cac(&uStack_30,&"TestingMgr",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01864aac;
  func_0x0124ec90(uStack_30,&UNK_01865070,1);
  ...
  func_0x0124f120(uVar2,&"syncNodeList");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x01864ab4(&uStack_30,&"skinSubId",&UNK_01864c9c,0,&UNK_01864ca4,0);
