...
void case687_HeroComponentLevelMgr(undefined8 param_1)

{
  ...
  func_0x0194cc6c(&uStack_40,&"HeroComponentLevelMgr",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0194ca14(&uStack_40,&"upNeedExp",&UNK_0194cbfc,0,&UNK_0194cc04,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0194cc64;
  func_0x0124ec90(*puVar3,&UNK_0194d3e4,1);
