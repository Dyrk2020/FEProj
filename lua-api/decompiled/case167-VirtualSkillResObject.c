...
void case167_VirtualSkillResObject(undefined8 param_1)

{
  ...
  func_0x017aad04(&uStack_30,&"VirtualSkillResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017aacfc;
  func_0x0124ec90(uStack_30,&UNK_017ab0c8,1);
