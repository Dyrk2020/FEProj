...
void case514_ActorActionAuxiliaryProcessor(undefined8 param_1)

{
  ...
  func_0x018a1984(&uStack_30,&"ActorActionAuxiliaryProcessor",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018a197c;
  func_0x0124ec90(uStack_30,&UNK_018a1d48,1);
