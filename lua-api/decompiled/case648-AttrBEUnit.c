...
void case648_AttrBEUnit(undefined8 param_1)

{
  ...
  func_0x019255f4(&uStack_40,&"AttrBEUnit",&uStack_50,0x736d101);
  uVar3 = func_0x01925334(&uStack_40,&"modRate",&UNK_0192551c,0,&UNK_01925524,0);
  puVar4 = (undefined8 *)func_0x01925334(uVar3,&"modValue",&UNK_01925584,0,&UNK_0192558c,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_019255ec;
  func_0x0124ec90(*puVar4,&UNK_01925ed4,1);
  ...
  func_0x0124f120(uVar3,&"cacheBuff");
