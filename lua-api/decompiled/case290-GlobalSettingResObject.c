...
void case290_GlobalSettingResObject(undefined8 param_1)

{
  ...
  func_0x017f08c0(&uStack_30,&"GlobalSettingResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017f06c0;
  func_0x0124ec90(uStack_30,&UNK_017f0c84,1);
  ...
  func_0x0124f120(uVar2,&"playerBehaviorConfig");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x017f06c8(&uStack_30,&"playerReconnectProtectTime",&UNK_017f08b0,0,&UNK_017f08b8,0);
