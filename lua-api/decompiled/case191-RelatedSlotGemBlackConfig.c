...
void case191_RelatedSlotGemBlackConfig(undefined8 param_1)

{
  ...
  func_0x017b692c(&uStack_40,&"RelatedSlotGemBlackConfig",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x017b672c(&uStack_40,&"slotIndex",&UNK_017b6914,0,&UNK_017b691c,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017b6924;
  func_0x0124ec90(*puVar3,&UNK_017b6f10,1);
  ...
  func_0x0124f120(uVar5,&"blackConfigs");
