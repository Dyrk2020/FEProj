...
void case626_BattleCountdownMgr(undefined8 param_1)

{
  ...
  func_0x019060ec(&uStack_40,&"BattleCountdownMgr",&uStack_50,0x736d101);
  uVar3 = func_0x01905e2c(&uStack_40,&"countTime",&UNK_01906014,0,&UNK_0190601c,0);
  puVar4 = (undefined8 *)func_0x01905e2c(uVar3,&"battleBeginTime",&UNK_0190607c,0,&UNK_01906084,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_019060e4;
  func_0x0124ec90(*puVar4,&UNK_019069cc,1);
