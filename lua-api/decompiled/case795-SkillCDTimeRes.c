...
void case795_SkillCDTimeRes(undefined8 param_1)

{
  ...
  func_0x019b4408(&uStack_40,&"SkillCDTimeRes",&uStack_50,0x736d101);
  uVar3 = func_0x019b3e18(&uStack_40,&"time",&UNK_019b4000,0,&UNK_019b4008,0);
  puVar4 = (undefined8 *)func_0x019b4010(uVar3,&"type",&UNK_019b41f8,0,&UNK_019b4200,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_019b4208;
  func_0x0124ec90(*puVar4,&UNK_019b4c38,1);
  ...
  func_0x0124e060(uVar3,uVar2);
  func_0x0124c4d0(uVar3,0xfffffffd);
  puVar4 = (undefined8 *)func_0x019b4210(puVar4,&"ignoreCDReduce",&UNK_019b43f8,0,&UNK_019b4400,0);
