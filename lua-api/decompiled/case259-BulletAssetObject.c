...
void case259_BulletAssetObject(undefined8 param_1)

{
  ...
  func_0x017dc004(&uStack_40,&"BulletAssetObject",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x017dbe04(&uStack_40,&"resID",&UNK_017dbfec,0,&UNK_017dbff4,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017dbffc;
  func_0x0124ec90(*puVar3,&UNK_017dc5e8,1);
  ...
  func_0x0124f120(uVar5,&"resObject");
