...
void case459_PathMgrData(undefined8 param_1)

{
  ...
  func_0x0187182c(&uStack_30,&"PathMgrData",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01871824;
  func_0x0124ec90(uStack_30,&UNK_01871bf0,1);
  ...
  func_0x0124f120(uVar1,&"pathList");
