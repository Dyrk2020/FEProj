...
void case76_MonsterBehaviorLevelAudioConfig(undefined8 param_1)

{
  ...
  func_0x01779f8c(&uStack_40,&"MonsterBehaviorLevelAudioConfig",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x01779d7c(&uStack_40,&"nodeId",&UNK_01779f64,0,&UNK_01779f6c,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01779f74;
  func_0x0124ec90(*puVar3,&UNK_0177a570,1);
  ...
  func_0x0124f120(uVar5,&"eventName");
  ...
  func_0x0124e060(uVar5,uVar2);
  func_0x0124c4d0(uVar5,0xfffffffd);
  puVar3 = (undefined8 *)func_0x01779d7c(puVar3,&"fadeOutTimeMs",&UNK_01779f7c,0,&UNK_01779f84,0);
