...
void case630_BattlePlayerCommercialInfo(undefined8 param_1)

{
  ...
  func_0x0190b67c(&uStack_40,&"BattlePlayerCommercialInfo",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0190b468(&uStack_40,&"curInteractiveSkillDisguiseItemId",&UNK_0190b650,0,&UNK_0190b658,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0190b674;
  func_0x0124ec90(*puVar3,&UNK_0190bdc8,1);
  ...
  func_0x0124f120(uVar5,&"disguiseItemDic");
