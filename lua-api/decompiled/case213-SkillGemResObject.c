...
void case213_SkillGemResObject(undefined8 param_1)

{
  ...
  func_0x017c1bb4(&uStack_40,&"SkillGemResObject",&uStack_50,0x736d101);
  uVar3 = func_0x017c17bc(&uStack_40,&"enabled",&UNK_017c19a4,0,&UNK_017c19ac,0);
  puVar4 = (undefined8 *)func_0x017c19b4(uVar3,&"ruleType",&UNK_017c1b9c,0,&UNK_017c1ba4,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_017c1bac;
  func_0x0124ec90(*puVar4,&UNK_017c23b8,1);
  ...
  func_0x0124f120(uVar3,&"variable");
