...
void case711_ActorCfgData_ActorAniJointCfg(undefined8 param_1)

{
  ...
  func_0x0196c434(&uStack_30,&"ActorCfgData_ActorAniJointCfg",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0196c424;
  func_0x0124ec90(uStack_30,&UNK_0196c7f8,1);
  ...
  func_0x0124f120(uVar1,&"jointDatas");
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_0196c42c;
  func_0x0124ec90(uStack_30,&UNK_0196c91c,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar1,0xfffffffe);
  uVar3 = func_0x0124e920(uVar1,0xfffffffe);
  func_0x0124f120(uVar1,&"aniBlendDatas");
  func_0x0124cfc0(uVar1,0xfffffffe,1);
  func_0x0124e060(uVar1,uVar3);
  func_0x0124c4d0(uVar1,0xfffffffd);
  uVar1 = uStack_30;
