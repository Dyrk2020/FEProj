...
void case433_BattleMonsterGrowth(undefined8 param_1)

{
  ...
  func_0x018639d0(&uStack_30,&"BattleMonsterGrowth",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018639c8;
  func_0x0124ec90(uStack_30,&UNK_01863d94,1);
