// ===== case572-MapInfoPolyline @ 017022fc =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case572-MapInfoPolyline


void case572_MapInfoPolyline(undefined8 param_1)

{
  ...
  func_0x018e203c(&uStack_40,&"MapInfoPolyline",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x018e1e3c(&uStack_40,&"id",&UNK_018e2024,0,&UNK_018e202c,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018e2034;
  func_0x0124ec90(*puVar3,&UNK_018e2620,1);
  ...
  func_0x0124f120(uVar5,&"vertices");
