// ===== case800-FlowAssetObject @ 01733740 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case800-FlowAssetObject


void case800_FlowAssetObject(undefined8 param_1)

{
  ...
  func_0x019b7a9c(&uStack_40,&"FlowAssetObject",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x019b789c(&uStack_40,&"baseType",&UNK_019b7a84,0,&UNK_019b7a8c,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019b7a94;
  func_0x0124ec90(*puVar3,&UNK_019b8080,1);
