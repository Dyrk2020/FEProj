...
void case448_BattleLevelRule_DC(undefined8 param_1)

{
  ...
  func_0x0186c6f0(&uStack_30,&"BattleLevelRule_DC",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0186c6e8;
  func_0x0124ec90(uStack_30,&UNK_0186cab4,1);
  ...
  func_0x0124f120(uVar1,&"resLevelRhythm");
