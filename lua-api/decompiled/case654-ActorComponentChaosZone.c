// ===== case654-ActorComponentChaosZone @ 017155ac =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case654-ActorComponentChaosZone


void case654_ActorComponentChaosZone(undefined8 param_1)

{
  ...
  func_0x0192a394(&uStack_40,&"ActorComponentChaosZone",&uStack_50,0x736d101);
  uVar3 = func_0x0192a194(&uStack_40,&"preparedSlotGems",&UNK_0192a37c,0,0,0);
  puVar4 = (undefined8 *)func_0x0192a194(uVar3,&"preparedCommonGems",&UNK_0192a384,0,0,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_0192a38c;
  func_0x0124ec90(*puVar4,&UNK_0192a9cc,1);
  ...
  func_0x0124f120(uVar3,&"holdSelectGems");
