...
void case121_BattleTaskResObject(undefined8 param_1)

{
  ...
  func_0x01792730(&uStack_30,&"BattleTaskResObject* >",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01792720;
  func_0x0124ec90(uStack_30,&UNK_01792af4,1);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_01792728;
  func_0x0124ec90(uStack_30,&UNK_01792c18,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar1,0xfffffffe);
