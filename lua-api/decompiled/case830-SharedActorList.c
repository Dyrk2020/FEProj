...
void case830_SharedActorList(undefined8 param_1)

{
  ...
  func_0x019d4994(&uStack_30,&"SharedActorList",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019d498c;
  func_0x0124ec90(uStack_30,&UNK_019d4d58,1);
  ...
  func_0x0124f120(uVar1,&"rawValue");
