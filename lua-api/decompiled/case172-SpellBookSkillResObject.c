...
void case172_SpellBookSkillResObject(undefined8 param_1)

{
  ...
  func_0x017ad86c(&uStack_40,&"SpellBookSkillResObject",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_40,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_017ad644;
  func_0x0124ec90(uStack_40,&UNK_017adc30,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x017ad64c(&uStack_40,&"enableReplaceModel",&UNK_017ad834,0,&UNK_017ad83c,0);
  uVar4 = func_0x017ad64c(uVar4,&"disable",&UNK_017ad844,0,&UNK_017ad84c,0);
  puVar3 = (undefined8 *)func_0x017ad64c(uVar4,&"disableUSBCDRule",&UNK_017ad854,0,&UNK_017ad85c,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_017ad864;
  func_0x0124ec90(*puVar3,&UNK_017adf74,1);
  func_0x0124c0c0(*puVar3,0xffffffff);
  uVar4 = *puVar3;
  func_0x0124a650(uVar4,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar4,0xfffffffe);
  uVar2 = func_0x0124e920(uVar4,0xfffffffe);
  func_0x0124f120(uVar4,&"cdReduce");
  func_0x0124cfc0(uVar4,0xfffffffe,1);
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = *puVar3;
