...
void case338_ActorManager(undefined8 param_1)

{
  ...
  func_0x0181268c(&uStack_30,&"ActorManager",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01812684;
  func_0x0124ec90(uStack_30,&UNK_01812a50,1);
  ...
  func_0x0124f120(uVar1,&"actorList");
