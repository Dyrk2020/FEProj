...
void case774_Bullet_DC(undefined8 param_1)

{
  ...
  func_0x019a3214(&uStack_30,&"Bullet_DC",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_019a320c;
  func_0x0124ec90(uStack_30,&UNK_019a35d8,1);
