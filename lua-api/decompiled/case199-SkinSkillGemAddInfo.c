...
void case199_SkinSkillGemAddInfo(undefined8 param_1)

{
  ...
  func_0x017ba488(&uStack_30,&"SkinSkillGemAddInfo",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017ba480;
  func_0x0124ec90(uStack_30,&UNK_017ba84c,1);
  ...
  func_0x0124f120(uVar1,&"slotAddInfos");
