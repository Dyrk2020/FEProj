...
void case613_MapAnchorFlowComponent(undefined8 param_1)

{
  ...
  func_0x018fb008(&uStack_30,&"MapAnchorFlowComponent",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018faff8;
  func_0x0124ec90(uStack_30,&UNK_018fb3cc,1);
  ...
  func_0x0124f120(uVar1,&"anchorFlow");
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_018fb000;
  func_0x0124ec90(uStack_30,&UNK_018fb4f0,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar1,0xfffffffe);
  uVar3 = func_0x0124e920(uVar1,0xfffffffe);
  func_0x0124f120(uVar1,&"anchorParallelFlow");
  func_0x0124cfc0(uVar1,0xfffffffe,1);
  func_0x0124e060(uVar1,uVar3);
  func_0x0124c4d0(uVar1,0xfffffffd);
  uVar1 = uStack_30;
