...
void case220_ChampionGainConfigResObject(undefined8 param_1)

{
  ...
  func_0x017c5a50(&uStack_30,&"ChampionGainConfigResObject* >",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017c5a40;
  func_0x0124ec90(uStack_30,&UNK_017c5e14,1);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_017c5a48;
  func_0x0124ec90(uStack_30,&UNK_017c5f38,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar1,0xfffffffe);
