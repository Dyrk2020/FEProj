...
void case209_SkillStrengthenOptionalRuleType(undefined8 param_1)

{
  ...
  func_0x017bf440(&uStack_40,&"SkillStrengthenOptionalRuleType",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x017bf240(&uStack_40,&"ruleType",&UNK_017bf428,0,&UNK_017bf430,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017bf438;
  func_0x0124ec90(*puVar3,&UNK_017bfa24,1);
  ...
  func_0x0124f120(uVar5,&"variable");
