...
void case301_AIHeroOrientationResObject(undefined8 param_1)

{
  ...
  func_0x017f61f0(&uStack_30,&"AIHeroOrientationResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017f5ff0;
  func_0x0124ec90(uStack_30,&UNK_017f65b4,1);
  ...
  func_0x0124f120(uVar2,&"aiHeroOrientationList");
  ...
  func_0x0124e060(uVar2,uVar3);
  func_0x0124c4d0(uVar2,0xfffffffd);
  puVar4 = (undefined8 *)func_0x017f5ff8(&uStack_30,&"MaxOrientationNum",&UNK_017f61e0,0,&UNK_017f61e8,0);
