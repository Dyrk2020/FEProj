...
void case163_EquipResObject_EquipSkill(undefined8 param_1)

{
  ...
  func_0x017a7de4(&uStack_40,&"EquipResObject_EquipSkill",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_40,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_017a79c4;
  func_0x0124ec90(uStack_40,&UNK_017a81a8,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x017a79cc(&uStack_40,&"priority",&UNK_017a7bb4,0,&UNK_017a7bbc,0);
  puVar3 = (undefined8 *)func_0x017a79cc(uVar4,&"group",&UNK_017a7bc4,0,&UNK_017a7bcc,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_017a7bd4;
  func_0x0124ec90(*puVar3,&UNK_017a84ec,1);
  func_0x0124c0c0(*puVar3,0xffffffff);
  uVar4 = *puVar3;
  func_0x0124a650(uVar4,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar4,0xfffffffe);
  uVar2 = func_0x0124e920(uVar4,0xfffffffe);
  func_0x0124f120(uVar4,&"desc");
  func_0x0124cfc0(uVar4,0xfffffffe,1);
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = *puVar3;
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x017a7bdc(puVar3,&"stealDisable",&UNK_017a7dc4,0,&UNK_017a7dcc,0);
  puVar3 = (undefined8 *)func_0x017a7bdc(uVar4,&"canOverLay",&UNK_017a7dd4,0,&UNK_017a7ddc,0);
