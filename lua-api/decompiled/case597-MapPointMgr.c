// ===== case597-MapPointMgr @ 017066c4 =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case597-MapPointMgr


void case597_MapPointMgr(undefined8 param_1)

{
  ...
  func_0x018f00d4(&uStack_30,&"MapPointMgr",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018f00cc;
  func_0x0124ec90(uStack_30,&UNK_018f0498,1);
  ...
  func_0x0124f120(uVar1,&"mapPointList");
