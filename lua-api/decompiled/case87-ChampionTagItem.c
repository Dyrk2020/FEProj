...
void case87_ChampionTagItem(undefined8 param_1)

{
  ...
  func_0x01780fa0(&uStack_30,&"ChampionTagItem",&uStack_40,0x736d101);
  puVar3 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar3[1] = 0;
  *puVar3 = &UNK_01780d90;
  func_0x0124ec90(uStack_30,&UNK_01781364,1);
  ...
  func_0x0124e060(uVar4,uVar2);
  func_0x0124c4d0(uVar4,0xfffffffd);
  uVar4 = func_0x01780d98(&uStack_30,&"iIncludeTag",&UNK_01780f80,0,&UNK_01780f88,0);
  puVar3 = (undefined8 *)func_0x01780d98(uVar4,&"iExcludeTag",&UNK_01780f90,0,&UNK_01780f98,0);
