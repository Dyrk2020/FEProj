...
void case59_ForgeHeroSetting(undefined8 param_1)

{
  ...
  func_0x017711b0(&uStack_40,&"ForgeHeroSetting",&uStack_50,0x736d101);
  uVar3 = func_0x01770f70(&uStack_40,&"heroID",&UNK_01771158,0,&UNK_01771160,0);
  uVar3 = func_0x01770f70(uVar3,&"attackType",&UNK_01771168,0,&UNK_01771170,0);
  uVar3 = func_0x01770f70(uVar3,&"damageType",&UNK_01771178,0,&UNK_01771180,0);
  uVar3 = func_0x01770f70(uVar3,&"resourceType",&UNK_01771188,0,&UNK_01771190,0);
  puVar4 = (undefined8 *)func_0x01770f70(uVar3,&"rejectTags",&UNK_01771198,0,&UNK_017711a0,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_017711a8;
  func_0x0124ec90(*puVar4,&UNK_01771794,1);
  ...
  func_0x0124f120(uVar3,&"basicStyle");
