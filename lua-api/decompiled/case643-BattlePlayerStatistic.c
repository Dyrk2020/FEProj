...
void case643_BattlePlayerStatistic(undefined8 param_1)

{
  ...
  func_0x0191ffc0(&uStack_30,&"BattlePlayerStatistic",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0191ffb8;
  func_0x0124ec90(uStack_30,&UNK_01920384,1);
  ...
  func_0x0124f120(uVar1,&"_battleHero");
