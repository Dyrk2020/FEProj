...
void case62_JungleGuideResObject(undefined8 param_1)

{
  ...
  func_0x01773214(&uStack_30,&"JungleGuideResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0177320c;
  func_0x0124ec90(uStack_30,&UNK_017735d8,1);
  ...
  func_0x0124f120(uVar1,&"jungleGuides");
