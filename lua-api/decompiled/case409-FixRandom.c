...
void case409_FixRandom(undefined8 param_1)

{
  ...
  func_0x0185307c(&uStack_40,&"FixRandom",&uStack_50,0x736d101);
  uVar3 = func_0x01852c18(&uStack_40,&"fix_seed",&UNK_01852e00,0,&UNK_01852e08,0);
  puVar4 = (undefined8 *)func_0x01852e68(uVar3,&"useed",&UNK_01853050,0,&UNK_01853058,0);
  puVar5 = (undefined8 *)func_0x0124cba0(*puVar4,0x10);
  puVar5[1] = 0;
  *puVar5 = &UNK_01853074;
  func_0x0124ec90(*puVar4,&UNK_01853a9c,1);
