...
void case442_BattleState(undefined8 param_1)

{
  ...
  func_0x018685d4(&uStack_40,&"BattleState",&uStack_50,0x736d101);
  puVar3 = (undefined8 *)func_0x018683c0(&uStack_40,&"stateId",&UNK_018685a8,0,&UNK_018685b0,0);
  puVar4 = (undefined8 *)func_0x0124cba0(*puVar3,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018685cc;
  func_0x0124ec90(*puVar3,&UNK_01868d20,1);
