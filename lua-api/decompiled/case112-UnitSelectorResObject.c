...
void case112_UnitSelectorResObject(undefined8 param_1)

{
  ...
  func_0x0178d268(&uStack_30,&"UnitSelectorResObject",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0178d260;
  func_0x0124ec90(uStack_30,&UNK_0178d62c,1);
  ...
  func_0x0124f120(uVar1,&"unitSelectorList");
