// ===== case175-LevelSkillResObject @ 016aaebc =====
// NOTE: &UNK_<ghidra-addr> references that resolve to printable strings in the
// runtime string pools (plaintext or dword-XOR 0x30 islands, delta sweep) were
// rewritten as &"<string>" by postprocess.py; code/data addresses remain as &UNK_.
// existing function case175-LevelSkillResObject


void case175_LevelSkillResObject(undefined8 param_1)

{
  ...
  func_0x017aeeb0(&uStack_30,&"LevelSkillResObject* >",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_017aeea0;
  func_0x0124ec90(uStack_30,&UNK_017af274,1);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_017aeea8;
  func_0x0124ec90(uStack_30,&UNK_017af398,1);
  func_0x0124c0c0(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  func_0x0124a650(uStack_30,0xfffffffb,0x6e7);
  func_0x0124c0c0(uVar1,0xfffffffe);
