...
void case332_NonRecoverConsistencyStaticVars(undefined8 param_1)

{
  ...
  func_0x018107c0(&uStack_30,&"NonRecoverConsistencyStaticVars",&uStack_40,0x736d101);
  puVar4 = (undefined8 *)func_0x0124cba0(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_018107b8;
  func_0x0124ec90(uStack_30,&UNK_01810b84,1);
  ...
  func_0x0124f120(uVar1,&"frameDumperInterface");
