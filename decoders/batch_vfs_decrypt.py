...
def main():
    ...
    roots = [
        "<research-workspace>/corpus/basic-data/external-device-20260812/files/DynDL-LData",
        "<research-workspace>/corpus/basic-data/external-device-20260812/files/Res/LData",
    ]
    files = []
    for r in roots:
        if os.path.isdir(r):
    ...
    t0 = time.time()
    outdir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "decrypted-samples")
