// ===== case743_BuffLevelData_sub1981254 @ 01981254 (DecompileAt3: cleared stale instructions at entry) =====


undefined8 *
case743_BuffLevelData_sub1981254
...

{
  ...
  *puVar2 = param_3;
  puVar2[1] = param_4;
  func_0x0124ec90(*param_1,&UNK_01981e08,1);
  ...
  if ((param_5 != 0) || (param_6 != 0 && (param_6 & 1) != 0)) {
    ...
    *plVar3 = param_5;
    plVar3[1] = param_6;
    func_0x0124ec90(*param_1,&UNK_01981e7c,1);
    uVar4 = *param_1;
