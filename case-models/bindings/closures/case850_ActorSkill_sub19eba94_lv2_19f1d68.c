...
byte * case850_ActorSkill_sub19eba94_lv2_19f1d68(byte *param_1,uint param_2)

{
  ...
  if ((uint)*param_1 != (param_2 & 0xff)) {
    if (*(long *)PTR_07319548 == 0) {
      ...
      *PTR_07317d28 = 0;
      ...
      if ((cVar6 != '\0') && ((uint)*param_1 != (param_2 & 0xff))) {
        if (0 < *(int *)(param_1 + -0x6d6)) {
          lVar7 = func_0x01b4635c();
          lVar7 = *(long *)(lVar7 + 0x38);
          *(int *)(lVar7 + 0x10) = *(int *)(param_1 + -0x6d6) + 0x164;
          func_0x01b4907c(lVar7,param_2,0x893);
        }
      }
      *puVar4 = 0;
      *(undefined8 *)puVar5 = 0;
    ...
    *param_1 = abStack_34[0];
    uVar2 = *(uint *)(param_1 + -0x6da);
    uVar3 = uVar2;
    if ((int)uVar2 < 0) {
      uVar3 = *(uint *)(param_1 + (-0x6e2 - (long)(short)uVar2));
    }
    uVar1 = 0;
    if ((int)uVar2 < 0) {
    ...
    if ((int)uVar3 < 0) {
      ...
      func_0x01b1d810(uVar3,uVar1,0x32,abStack_34);
    }
  }
  return param_1;
}
