// ===== case37_FEBattleContext_sub1763194 @ 01763194 (DecompileAt3: cleared stale instructions at entry) =====


undefined8 *
case37_FEBattleContext_sub1763194
...

{
  ...
  *puVar2 = param_3;
  puVar2[1] = param_4;
  func_0x0124ec90(*param_1,&UNK_017640d4,1);
  ...
  if ((param_5 != 0) || (param_6 != 0 && (param_6 & 1) != 0)) {
    ...
    *plVar3 = param_5;
    plVar3[1] = param_6;
    func_0x0124ec90(*param_1,&UNK_01764148,1);
    uVar4 = *param_1;
