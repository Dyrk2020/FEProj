// ===== case850_ActorSkill_sub19e9ce8_lv2_19edd24 @ 019edd24 (DecompileAt3: cleared stale instructions at entry) =====
019edd24  stp x22,x21,[sp, #-0x30]!
019edd28  stp x20,x19,[sp, #0x10]
019edd2c  stp x29,x30,[sp, #0x20]
019edd30  add x29,sp,#0x20
019edd34  mov x19,x0
019edd38  ldr w8,[x19]
019edd3c  mov w20,w1
019edd40  cmp w8,w20
019edd44  b.eq 0x019ede08
019edd48  adrp x21,0x7319000
019edd4c  ldr x21,[x21, #0x548]
019edd50  ldr x8,[x21]
019edd54  cbz x8,0x019edda4
019edd58  mov x0,xzr
019edd5c  bl 0x01b4868c
019edd60  tst w0,#0xff
019edd64  b.eq 0x019ede04
019edd68  ldr w8,[x19]
019edd6c  cmp w8,w20
019edd70  b.eq 0x019ede04
019edd74  ldur w8,[x19, #-0x7c]
019edd78  cmp w8,#0x1
019edd7c  b.lt 0x019ede04
019edd80  bl 0x01b4635c
019edd84  ldur w8,[x19, #-0x7c]
019edd88  ldr x0,[x0, #0x38]
019edd8c  mov w2,#0x80f
019edd90  mov w1,w20
019edd94  add w8,w8,#0x31
019edd98  str w8,[x0, #0x10]
019edd9c  bl 0x01b490fc
019edda0  b 0x019ede04
019edda4  str x30,[x21]
019edda8  adrp x22,0x7317000
019eddac  ldr x22,[x22, #0xd28]
019eddb0  mov x0,xzr
019eddb4  strb wzr,[x22]
019eddb8  bl 0x01b4868c
019eddbc  tst w0,#0xff
019eddc0  b.eq 0x019eddfc
019eddc4  ldr w8,[x19]
019eddc8  cmp w8,w20
019eddcc  b.eq 0x019eddfc
019eddd0  ldur w8,[x19, #-0x7c]
019eddd4  cmp w8,#0x1
019eddd8  b.lt 0x019eddfc
019edddc  bl 0x01b4635c
019edde0  ldur w8,[x19, #-0x7c]
019edde4  ldr x0,[x0, #0x38]
019edde8  mov w2,#0x80f
019eddec  mov w1,w20
019eddf0  add w8,w8,#0x31
019eddf4  str w8,[x0, #0x10]
019eddf8  bl 0x01b490fc
019eddfc  strb wzr,[x22]
019ede00  str xzr,[x21]
019ede04  str w20,[x19]
019ede08  mov x0,x19
019ede0c  ldp x29,x30,[sp, #0x20]
019ede10  ldp x20,x19,[sp, #0x10]
019ede14  ldp x22,x21,[sp], #0x30
019ede18  ret
