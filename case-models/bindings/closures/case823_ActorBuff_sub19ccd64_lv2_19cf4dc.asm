// ===== case823_ActorBuff_sub19ccd64_lv2_19cf4dc @ 019cf4dc (DecompileAt3: cleared stale instructions at entry) =====
019cf4dc  str x23,[sp, #-0x40]!
019cf4e0  stp x22,x21,[sp, #0x10]
019cf4e4  stp x20,x19,[sp, #0x20]
019cf4e8  stp x29,x30,[sp, #0x30]
019cf4ec  add x29,sp,#0x30
019cf4f0  mov x19,x0
019cf4f4  ldrb w8,[x19]
019cf4f8  mov w20,w1
019cf4fc  cmp w8,w20, UXTB 
019cf500  b.eq 0x019cf5cc
019cf504  adrp x21,0x7319000
019cf508  ldr x21,[x21, #0x548]
019cf50c  ldr x8,[x21]
019cf510  cbz x8,0x019cf564
019cf514  mov x0,xzr
019cf518  bl 0x01b4868c
019cf51c  tst w0,#0xff
019cf520  b.eq 0x019cf5c8
019cf524  ldrb w8,[x19]
019cf528  cmp w8,w20, UXTB 
019cf52c  b.eq 0x019cf5c8
019cf530  sub x21,x19,#0x1bc
019cf534  ldr w8,[x21]
019cf538  cmp w8,#0x1
019cf53c  b.lt 0x019cf5c8
019cf540  bl 0x01b4635c
019cf544  ldr w8,[x21]
019cf548  ldr x0,[x0, #0x38]
019cf54c  mov w2,#0x24c2
019cf550  mov w1,w20
019cf554  add w8,w8,#0x87
019cf558  str w8,[x0, #0x10]
019cf55c  bl 0x01b4907c
019cf560  b 0x019cf5c8
019cf564  str x30,[x21]
019cf568  adrp x22,0x7317000
019cf56c  ldr x22,[x22, #0xd28]
019cf570  mov x0,xzr
019cf574  strb wzr,[x22]
019cf578  bl 0x01b4868c
019cf57c  tst w0,#0xff
019cf580  b.eq 0x019cf5c0
019cf584  ldrb w8,[x19]
019cf588  cmp w8,w20, UXTB 
019cf58c  b.eq 0x019cf5c0
019cf590  sub x23,x19,#0x1bc
019cf594  ldr w8,[x23]
019cf598  cmp w8,#0x1
019cf59c  b.lt 0x019cf5c0
019cf5a0  bl 0x01b4635c
019cf5a4  ldr w8,[x23]
019cf5a8  ldr x0,[x0, #0x38]
019cf5ac  mov w2,#0x24c2
019cf5b0  mov w1,w20
019cf5b4  add w8,w8,#0x87
019cf5b8  str w8,[x0, #0x10]
019cf5bc  bl 0x01b4907c
019cf5c0  strb wzr,[x22]
019cf5c4  str xzr,[x21]
019cf5c8  strb w20,[x19]
019cf5cc  mov x0,x19
019cf5d0  ldp x29,x30,[sp, #0x30]
019cf5d4  ldp x20,x19,[sp, #0x20]
019cf5d8  ldp x22,x21,[sp, #0x10]
019cf5dc  ldr x23,[sp], #0x40
019cf5e0  ret
