// ===== case744_BuffResObject_sub1982730 @ 01982730 (DecompileAt3: cleared stale instructions at entry) =====


undefined8 *
case744_BuffResObject_sub1982730
...

{
  ...
  *puVar2 = param_3;
  puVar2[1] = param_4;
  func_0x0124ec90(*param_1,&UNK_01983634,1);
  ...
  if ((param_5 != 0) || (param_6 != 0 && (param_6 & 1) != 0)) {
    ...
    *plVar3 = param_5;
    plVar3[1] = param_6;
    func_0x0124ec90(*param_1,&UNK_019836a8,1);
    uVar4 = *param_1;
