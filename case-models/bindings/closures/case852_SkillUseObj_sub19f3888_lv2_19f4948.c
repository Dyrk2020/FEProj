...
int * case852_SkillUseObj_sub19f3888_lv2_19f4948(int *param_1,int param_2)
  ...
  if (*param_1 != param_2) {
    if (*(long *)PTR_07319548 == 0) {
      ...
      *PTR_07317d28 = 0;
      ...
      if (((cVar3 != '\0') && (*param_1 != param_2)) && (0 < param_1[-0x20])) {
        lVar4 = func_0x01b4635c();
        lVar4 = *(long *)(lVar4 + 0x38);
        *(int *)(lVar4 + 0x10) = param_1[-0x20] + 0x2b;
        func_0x01b490fc(lVar4,param_2,0x478);
      }
      *puVar1 = 0;
      *(undefined8 *)puVar2 = 0;
    }
