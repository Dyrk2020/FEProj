// ===== case850_ActorSkill_sub19e9954_lv2_19ed1b8 @ 019ed1b8 (DecompileAt3: cleared stale instructions at entry) =====
019ed1b8  sub sp,sp,#0x40
019ed1bc  stp x22,x21,[sp, #0x10]
019ed1c0  stp x20,x19,[sp, #0x20]
019ed1c4  stp x29,x30,[sp, #0x30]
019ed1c8  add x29,sp,#0x30
019ed1cc  mov x19,x0
019ed1d0  ldrb w8,[x19]
019ed1d4  mov w20,w1
019ed1d8  cmp w8,w20, UXTB 
019ed1dc  b.eq 0x019ed308
019ed1e0  adrp x21,0x7319000
019ed1e4  ldr x21,[x21, #0x548]
019ed1e8  ldr x8,[x21]
019ed1ec  cbz x8,0x019ed23c
019ed1f0  mov x0,xzr
019ed1f4  bl 0x01b4868c
019ed1f8  tst w0,#0xff
019ed1fc  b.eq 0x019ed29c
019ed200  ldrb w8,[x19]
019ed204  cmp w8,w20, UXTB 
019ed208  b.eq 0x019ed29c
019ed20c  ldur w8,[x19, #-0x4c]
019ed210  cmp w8,#0x1
019ed214  b.lt 0x019ed29c
019ed218  bl 0x01b4635c
019ed21c  ldur w8,[x19, #-0x4c]
019ed220  ldr x0,[x0, #0x38]
019ed224  mov w2,#0x7fd
019ed228  mov w1,w20
019ed22c  add w8,w8,#0x13
019ed230  str w8,[x0, #0x10]
019ed234  bl 0x01b4907c
019ed238  b 0x019ed29c
019ed23c  str x30,[x21]
019ed240  adrp x22,0x7317000
019ed244  ldr x22,[x22, #0xd28]
019ed248  mov x0,xzr
019ed24c  strb wzr,[x22]
019ed250  bl 0x01b4868c
019ed254  tst w0,#0xff
019ed258  b.eq 0x019ed294
019ed25c  ldrb w8,[x19]
019ed260  cmp w8,w20, UXTB 
019ed264  b.eq 0x019ed294
019ed268  ldur w8,[x19, #-0x4c]
019ed26c  cmp w8,#0x1
019ed270  b.lt 0x019ed294
019ed274  bl 0x01b4635c
019ed278  ldur w8,[x19, #-0x4c]
019ed27c  ldr x0,[x0, #0x38]
019ed280  mov w2,#0x7fd
019ed284  mov w1,w20
019ed288  add w8,w8,#0x13
019ed28c  str w8,[x0, #0x10]
019ed290  bl 0x01b4907c
019ed294  strb wzr,[x22]
019ed298  str xzr,[x21]
019ed29c  ldur w9,[x19, #-0x50]
019ed2a0  strb w20,[x19]
019ed2a4  mov w8,w9
019ed2a8  tbz w9,#0x1f,0x019ed2b8
019ed2ac  sub x8,x19,#0x58
019ed2b0  sub x8,x8,w9, SXTH 
019ed2b4  ldr w8,[x8]
019ed2b8  ubfx w10,w9,#0x10,#0xf
019ed2bc  cmp w9,#0x0
019ed2c0  csel w1,wzr,w10,ge
019ed2c4  strb w20,[sp, #0xc]
019ed2c8  tbnz w8,#0x1f,0x019ed2e4
019ed2cc  cbz w8,0x019ed308
019ed2d0  mov w2,#0x8
019ed2d4  add x3,sp,#0xc
019ed2d8  mov w0,w8
019ed2dc  bl 0x01b1d810
019ed2e0  b 0x019ed308
019ed2e4  mov x3,#0x6472
019ed2e8  adrp x2,0x574b000
019ed2ec  movk x3,#0x7474, LSL #16
019ed2f0  add x2,x2,#0x398
019ed2f4  mov w1,#0x1
019ed2f8  movk x3,#0x100, LSL #48
019ed2fc  mov w0,wzr
019ed300  mov w4,w8
019ed304  bl 0x01b83618
019ed308  mov x0,x19
019ed30c  ldp x29,x30,[sp, #0x30]
019ed310  ldp x20,x19,[sp, #0x20]
019ed314  ldp x22,x21,[sp, #0x10]
019ed318  add sp,sp,#0x40
019ed31c  ret
019ed320  sub sp,sp,#0x40
019ed324  stp x22,x21,[sp, #0x10]
019ed328  stp x20,x19,[sp, #0x20]
019ed32c  stp x29,x30,[sp, #0x30]
019ed330  add x29,sp,#0x30
019ed334  mov x19,x0
019ed338  ldr w8,[x19]
019ed33c  mov w20,w1
019ed340  cmp w8,w20
019ed344  b.eq 0x019ed470
019ed348  adrp x21,0x7319000
019ed34c  ldr x21,[x21, #0x548]
019ed350  ldr x8,[x21]
019ed354  cbz x8,0x019ed3a4
019ed358  mov x0,xzr
019ed35c  bl 0x01b4868c
019ed360  tst w0,#0xff
019ed364  b.eq 0x019ed404
019ed368  ldr w8,[x19]
019ed36c  cmp w8,w20
019ed370  b.eq 0x019ed404
019ed374  ldur w8,[x19, #-0x50]
019ed378  cmp w8,#0x1
019ed37c  b.lt 0x019ed404
019ed380  bl 0x01b4635c
019ed384  ldur w8,[x19, #-0x50]
019ed388  ldr x0,[x0, #0x38]
019ed38c  orr w2,wzr,#0x7ff
019ed390  mov w1,w20
019ed394  add w8,w8,#0x14
019ed398  str w8,[x0, #0x10]
019ed39c  bl 0x01b490fc
019ed3a0  b 0x019ed404
019ed3a4  str x30,[x21]
019ed3a8  adrp x22,0x7317000
019ed3ac  ldr x22,[x22, #0xd28]
019ed3b0  mov x0,xzr
019ed3b4  strb wzr,[x22]
019ed3b8  bl 0x01b4868c
019ed3bc  tst w0,#0xff
019ed3c0  b.eq 0x019ed3fc
019ed3c4  ldr w8,[x19]
019ed3c8  cmp w8,w20
019ed3cc  b.eq 0x019ed3fc
019ed3d0  ldur w8,[x19, #-0x50]
019ed3d4  cmp w8,#0x1
019ed3d8  b.lt 0x019ed3fc
019ed3dc  bl 0x01b4635c
019ed3e0  ldur w8,[x19, #-0x50]
019ed3e4  ldr x0,[x0, #0x38]
019ed3e8  orr w2,wzr,#0x7ff
019ed3ec  mov w1,w20
019ed3f0  add w8,w8,#0x14
019ed3f4  str w8,[x0, #0x10]
019ed3f8  bl 0x01b490fc
019ed3fc  strb wzr,[x22]
019ed400  str xzr,[x21]
019ed404  ldur w9,[x19, #-0x54]
019ed408  str w20,[x19]
019ed40c  mov w8,w9
019ed410  tbz w9,#0x1f,0x019ed420
019ed414  sub x8,x19,#0x5c
019ed418  sub x8,x8,w9, SXTH 
019ed41c  ldr w8,[x8]
019ed420  ubfx w10,w9,#0x10,#0xf
019ed424  cmp w9,#0x0
019ed428  csel w1,wzr,w10,ge
019ed42c  str w20,[sp, #0xc]
019ed430  tbnz w8,#0x1f,0x019ed44c
019ed434  cbz w8,0x019ed470
019ed438  mov w2,#0x9
019ed43c  add x3,sp,#0xc
019ed440  mov w0,w8
019ed444  bl 0x01b1d8c0
019ed448  b 0x019ed470
019ed44c  mov x3,#0x6472
019ed450  adrp x2,0x574b000
019ed454  movk x3,#0x7474, LSL #16
019ed458  add x2,x2,#0x398
019ed45c  mov w1,#0x1
019ed460  movk x3,#0x100, LSL #48
019ed464  mov w0,wzr
019ed468  mov w4,w8
019ed46c  bl 0x01b83618
019ed470  mov x0,x19
019ed474  ldp x29,x30,[sp, #0x30]
019ed478  ldp x20,x19,[sp, #0x20]
019ed47c  ldp x22,x21,[sp, #0x10]
019ed480  add sp,sp,#0x40
019ed484  ret
