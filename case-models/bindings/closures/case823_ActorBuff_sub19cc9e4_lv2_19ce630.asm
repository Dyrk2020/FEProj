// ===== case823_ActorBuff_sub19cc9e4_lv2_19ce630 @ 019ce630 (DecompileAt3: cleared stale instructions at entry) =====
019ce630  stp x22,x21,[sp, #-0x30]!
019ce634  stp x20,x19,[sp, #0x10]
019ce638  stp x29,x30,[sp, #0x20]
019ce63c  add x29,sp,#0x20
019ce640  mov x19,x0
019ce644  ldr x8,[x19]
019ce648  mov x20,x1
019ce64c  cmp x8,x20
019ce650  b.eq 0x019ce714
019ce654  adrp x21,0x7319000
019ce658  ldr x21,[x21, #0x548]
019ce65c  ldr x8,[x21]
019ce660  cbz x8,0x019ce6b0
019ce664  mov x0,xzr
019ce668  bl 0x01b4868c
019ce66c  tst w0,#0xff
019ce670  b.eq 0x019ce710
019ce674  ldr x8,[x19]
019ce678  cmp x8,x20
019ce67c  b.eq 0x019ce710
019ce680  ldur w8,[x19, #-0x3c]
019ce684  cmp w8,#0x1
019ce688  b.lt 0x019ce710
019ce68c  bl 0x01b4635c
019ce690  ldur w8,[x19, #-0x3c]
019ce694  ldr x0,[x0, #0x38]
019ce698  mov w2,#0x2496
019ce69c  mov x1,x20
019ce6a0  add w8,w8,#0x24
019ce6a4  str w8,[x0, #0x10]
019ce6a8  bl 0x01b490bc
019ce6ac  b 0x019ce710
019ce6b0  str x30,[x21]
019ce6b4  adrp x22,0x7317000
019ce6b8  ldr x22,[x22, #0xd28]
019ce6bc  mov x0,xzr
019ce6c0  strb wzr,[x22]
019ce6c4  bl 0x01b4868c
019ce6c8  tst w0,#0xff
019ce6cc  b.eq 0x019ce708
019ce6d0  ldr x8,[x19]
019ce6d4  cmp x8,x20
019ce6d8  b.eq 0x019ce708
019ce6dc  ldur w8,[x19, #-0x3c]
019ce6e0  cmp w8,#0x1
019ce6e4  b.lt 0x019ce708
019ce6e8  bl 0x01b4635c
019ce6ec  ldur w8,[x19, #-0x3c]
019ce6f0  ldr x0,[x0, #0x38]
019ce6f4  mov w2,#0x2496
019ce6f8  mov x1,x20
019ce6fc  add w8,w8,#0x24
019ce700  str w8,[x0, #0x10]
019ce704  bl 0x01b490bc
019ce708  strb wzr,[x22]
019ce70c  str xzr,[x21]
019ce710  str x20,[x19]
019ce714  mov x0,x19
019ce718  ldp x29,x30,[sp, #0x20]
019ce71c  ldp x20,x19,[sp, #0x10]
019ce720  ldp x22,x21,[sp], #0x30
019ce724  ret
