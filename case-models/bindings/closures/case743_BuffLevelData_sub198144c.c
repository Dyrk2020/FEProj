// ===== case743_BuffLevelData_sub198144c @ 0198144c (DecompileAt3: cleared stale instructions at entry) =====


undefined8 *
case743_BuffLevelData_sub198144c
...

{
  ...
  *puVar2 = param_3;
  puVar2[1] = param_4;
  func_0x0124ec90(*param_1,&UNK_01982028,1);
  ...
  if ((param_5 != 0) || (param_6 != 0 && (param_6 & 1) != 0)) {
    ...
    *plVar3 = param_5;
    plVar3[1] = param_6;
    func_0x0124ec90(*param_1,&UNK_0198209c,1);
    uVar4 = *param_1;
