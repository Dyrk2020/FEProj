// ===== case850_ActorSkill_sub19e9f5c_lv2_19ee338 @ 019ee338 (DecompileAt3: cleared stale instructions at entry) =====
019ee338  sub sp,sp,#0x40
019ee33c  stp x22,x21,[sp, #0x10]
019ee340  stp x20,x19,[sp, #0x20]
019ee344  stp x29,x30,[sp, #0x30]
019ee348  add x29,sp,#0x30
019ee34c  mov x19,x0
019ee350  ldr x8,[x19]
019ee354  mov x20,x1
019ee358  cmp x8,x20
019ee35c  b.eq 0x019ee488
019ee360  adrp x21,0x7319000
019ee364  ldr x21,[x21, #0x548]
019ee368  ldr x8,[x21]
019ee36c  cbz x8,0x019ee3bc
019ee370  mov x0,xzr
019ee374  bl 0x01b4868c
019ee378  tst w0,#0xff
019ee37c  b.eq 0x019ee41c
019ee380  ldr x8,[x19]
019ee384  cmp x8,x20
019ee388  b.eq 0x019ee41c
019ee38c  ldur w8,[x19, #-0xac]
019ee390  cmp w8,#0x1
019ee394  b.lt 0x019ee41c
019ee398  bl 0x01b4635c
019ee39c  ldur w8,[x19, #-0xac]
019ee3a0  ldr x0,[x0, #0x38]
019ee3a4  mov w2,#0x815
019ee3a8  mov x1,x20
019ee3ac  add w8,w8,#0x3d
019ee3b0  str w8,[x0, #0x10]
019ee3b4  bl 0x01b490bc
019ee3b8  b 0x019ee41c
019ee3bc  str x30,[x21]
019ee3c0  adrp x22,0x7317000
019ee3c4  ldr x22,[x22, #0xd28]
019ee3c8  mov x0,xzr
019ee3cc  strb wzr,[x22]
019ee3d0  bl 0x01b4868c
019ee3d4  tst w0,#0xff
019ee3d8  b.eq 0x019ee414
019ee3dc  ldr x8,[x19]
019ee3e0  cmp x8,x20
019ee3e4  b.eq 0x019ee414
019ee3e8  ldur w8,[x19, #-0xac]
019ee3ec  cmp w8,#0x1
019ee3f0  b.lt 0x019ee414
019ee3f4  bl 0x01b4635c
019ee3f8  ldur w8,[x19, #-0xac]
019ee3fc  ldr x0,[x0, #0x38]
019ee400  mov w2,#0x815
019ee404  mov x1,x20
019ee408  add w8,w8,#0x3d
019ee40c  str w8,[x0, #0x10]
019ee410  bl 0x01b490bc
019ee414  strb wzr,[x22]
019ee418  str xzr,[x21]
019ee41c  ldur w9,[x19, #-0xb0]
019ee420  str x20,[x19]
019ee424  mov w8,w9
019ee428  tbz w9,#0x1f,0x019ee438
019ee42c  sub x8,x19,#0xb8
019ee430  sub x8,x8,w9, SXTH 
019ee434  ldr w8,[x8]
019ee438  ubfx w10,w9,#0x10,#0xf
019ee43c  cmp w9,#0x0
019ee440  csel w1,wzr,w10,ge
019ee444  str x20,[sp, #0x8]
019ee448  tbnz w8,#0x1f,0x019ee464
019ee44c  cbz w8,0x019ee488
019ee450  mov w2,#0x11
019ee454  add x3,sp,#0x8
019ee458  mov w0,w8
019ee45c  bl 0x01b1d968
019ee460  b 0x019ee488
019ee464  mov x3,#0x6472
019ee468  adrp x2,0x574b000
019ee46c  movk x3,#0x7474, LSL #16
019ee470  add x2,x2,#0x398
019ee474  mov w1,#0x1
019ee478  movk x3,#0x100, LSL #48
019ee47c  mov w0,wzr
019ee480  mov w4,w8
019ee484  bl 0x01b83618
019ee488  mov x0,x19
019ee48c  ldp x29,x30,[sp, #0x30]
019ee490  ldp x20,x19,[sp, #0x20]
019ee494  ldp x22,x21,[sp, #0x10]
019ee498  add sp,sp,#0x40
019ee49c  ret
019ee4a0  sub sp,sp,#0x40
019ee4a4  stp x22,x21,[sp, #0x10]
019ee4a8  stp x20,x19,[sp, #0x20]
019ee4ac  stp x29,x30,[sp, #0x30]
019ee4b0  add x29,sp,#0x30
019ee4b4  mov x19,x0
019ee4b8  ldr x8,[x19]
019ee4bc  mov x20,x1
019ee4c0  cmp x8,x20
019ee4c4  b.eq 0x019ee5f0
019ee4c8  adrp x21,0x7319000
019ee4cc  ldr x21,[x21, #0x548]
019ee4d0  ldr x8,[x21]
019ee4d4  cbz x8,0x019ee524
019ee4d8  mov x0,xzr
019ee4dc  bl 0x01b4868c
019ee4e0  tst w0,#0xff
019ee4e4  b.eq 0x019ee584
019ee4e8  ldr x8,[x19]
019ee4ec  cmp x8,x20
019ee4f0  b.eq 0x019ee584
019ee4f4  ldur w8,[x19, #-0xb4]
019ee4f8  cmp w8,#0x1
019ee4fc  b.lt 0x019ee584
019ee500  bl 0x01b4635c
019ee504  ldur w8,[x19, #-0xb4]
019ee508  ldr x0,[x0, #0x38]
019ee50c  mov w2,#0x817
019ee510  mov x1,x20
019ee514  add w8,w8,#0x45
019ee518  str w8,[x0, #0x10]
019ee51c  bl 0x01b490bc
019ee520  b 0x019ee584
019ee524  str x30,[x21]
019ee528  adrp x22,0x7317000
019ee52c  ldr x22,[x22, #0xd28]
019ee530  mov x0,xzr
019ee534  strb wzr,[x22]
019ee538  bl 0x01b4868c
019ee53c  tst w0,#0xff
019ee540  b.eq 0x019ee57c
019ee544  ldr x8,[x19]
019ee548  cmp x8,x20
019ee54c  b.eq 0x019ee57c
019ee550  ldur w8,[x19, #-0xb4]
019ee554  cmp w8,#0x1
019ee558  b.lt 0x019ee57c
019ee55c  bl 0x01b4635c
019ee560  ldur w8,[x19, #-0xb4]
019ee564  ldr x0,[x0, #0x38]
019ee568  mov w2,#0x817
019ee56c  mov x1,x20
019ee570  add w8,w8,#0x45
019ee574  str w8,[x0, #0x10]
019ee578  bl 0x01b490bc
019ee57c  strb wzr,[x22]
019ee580  str xzr,[x21]
019ee584  ldur w9,[x19, #-0xb8]
019ee588  str x20,[x19]
019ee58c  mov w8,w9
019ee590  tbz w9,#0x1f,0x019ee5a0
019ee594  sub x8,x19,#0xc0
019ee598  sub x8,x8,w9, SXTH 
019ee59c  ldr w8,[x8]
019ee5a0  ubfx w10,w9,#0x10,#0xf
019ee5a4  cmp w9,#0x0
019ee5a8  csel w1,wzr,w10,ge
019ee5ac  str x20,[sp, #0x8]
019ee5b0  tbnz w8,#0x1f,0x019ee5cc
019ee5b4  cbz w8,0x019ee5f0
019ee5b8  mov w2,#0x12
019ee5bc  add x3,sp,#0x8
019ee5c0  mov w0,w8
019ee5c4  bl 0x01b1d968
019ee5c8  b 0x019ee5f0
019ee5cc  mov x3,#0x6472
019ee5d0  adrp x2,0x574b000
019ee5d4  movk x3,#0x7474, LSL #16
019ee5d8  add x2,x2,#0x398
019ee5dc  mov w1,#0x1
019ee5e0  movk x3,#0x100, LSL #48
019ee5e4  mov w0,wzr
019ee5e8  mov w4,w8
019ee5ec  bl 0x01b83618
019ee5f0  mov x0,x19
019ee5f4  ldp x29,x30,[sp, #0x30]
019ee5f8  ldp x20,x19,[sp, #0x20]
019ee5fc  ldp x22,x21,[sp, #0x10]
019ee600  add sp,sp,#0x40
019ee604  ret
