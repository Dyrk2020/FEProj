...
long * case850_ActorSkill_sub19eb36c_lv2_19eeff8(long *param_1,long param_2)
  ...
  if (*param_1 != param_2) {
    if (*(long *)PTR_07319548 == 0) {
      ...
      *PTR_07317d28 = 0;
      ...
      if (((cVar6 != '\0') && (*param_1 != param_2)) && (0 < *(int *)((long)param_1 + -0xfc))) {
        lVar7 = func_0x01b4635c();
        lVar7 = *(long *)(lVar7 + 0x38);
        *(int *)(lVar7 + 0x10) = *(int *)((long)param_1 + -0xfc) + 0x8d;
        func_0x01b490bc(lVar7,param_2,0x829);
      }
      *puVar4 = 0;
      *(undefined8 *)puVar5 = 0;
    }
    ...
    *param_1 = param_2;
    uVar2 = uVar3;
    if ((int)uVar3 < 0) {
      uVar2 = *(uint *)((long)param_1 + (-0x108 - (long)(short)uVar3));
    }
    uVar1 = 0;
    if ((int)uVar3 < 0) {
    ...
    if ((int)uVar2 < 0) {
      ...
      func_0x01b1d968(uVar2,uVar1,0x18,&lStack_38);
    }
  }
  return param_1;
}
