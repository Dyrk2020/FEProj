...
int * case850_ActorSkill_sub19e9d0c_lv2_19ede1c(int *param_1,int param_2)
  ...
  if (*param_1 != param_2) {
    if (*(long *)PTR_07319548 == 0) {
      ...
      *PTR_07317d28 = 0;
      ...
      if (((cVar6 != '\0') && (*param_1 != param_2)) && (0 < param_1[-0x20])) {
        lVar7 = func_0x01b4635c();
        lVar7 = *(long *)(lVar7 + 0x38);
        *(int *)(lVar7 + 0x10) = param_1[-0x20] + 0x35;
        func_0x01b490fc(lVar7,param_2,0x811);
      }
      *puVar4 = 0;
      *(undefined8 *)puVar5 = 0;
    }
    ...
    *param_1 = param_2;
    uVar2 = uVar3;
    if ((int)uVar3 < 0) {
      uVar2 = *(uint *)((long)param_1 + (-0x8c - (long)(short)uVar3));
    }
    uVar1 = 0;
    if ((int)uVar3 < 0) {
    ...
    if ((int)uVar2 < 0) {
      ...
      func_0x01b1d8c0(uVar2,uVar1,0xf,&iStack_34);
    }
  }
  return param_1;
}
