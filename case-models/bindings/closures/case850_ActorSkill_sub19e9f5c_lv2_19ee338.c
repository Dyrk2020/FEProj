...
long * case850_ActorSkill_sub19e9f5c_lv2_19ee338(long *param_1,long param_2)
  ...
  if (*param_1 != param_2) {
    if (*(long *)PTR_07319548 == 0) {
      ...
      *PTR_07317d28 = 0;
      ...
      if (((cVar6 != '\0') && (*param_1 != param_2)) && (0 < *(int *)((long)param_1 + -0xac))) {
        ...
        *(int *)(lVar7 + 0x10) = *(int *)((long)param_1 + -0xac) + 0x3d;
        func_0x01b490bc(lVar7,param_2,0x815);
      }
      *puVar4 = 0;
      *(undefined8 *)puVar5 = 0;
    }
    ...
    *param_1 = param_2;
    ...
    if ((int)uVar2 < 0) {
      ...
      func_0x01b1d968(uVar2,uVar1,0x11,&lStack_38);
    }
  }
  return param_1;
}
