// ===== case744_BuffResObject_sub1983270 @ 01983270 (DecompileAt3: cleared stale instructions at entry) =====


undefined8
case744_BuffResObject_sub1983270
...

{
  ...
  *(undefined4 *)(param_3 + 1) = 0;
  ...
  func_0x0124ec90(*param_1,0x19835f4,0);
  uVar5 = *param_1;
  ...
  *(int *)(param_1 + 1) = *(int *)(param_1 + 1) + 1;
  ...
  func_0x0124c0c0(*param_1,0xffffffff);
  func_0x01252d10(*param_1,0xfff0b9d8,0x736dcfb);
  func_0x0124c0c0(*param_1,0xfffffffe);
  func_0x01252d10(*param_1,0xfff0b9d8,0x736dcfc);
  func_0x0124c0c0(*param_1,0xfffffffd);
  uVar5 = func_0x01252d10(*param_1,0xfff0b9d8,0x736dcfd);
  return uVar5;
}
