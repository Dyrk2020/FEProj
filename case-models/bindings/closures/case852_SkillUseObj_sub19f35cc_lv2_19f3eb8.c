...
int * case852_SkillUseObj_sub19f35cc_lv2_19f3eb8(int *param_1,int param_2)
  ...
  if (*param_1 != param_2) {
    if (*(long *)PTR_07319548 == 0) {
      ...
      *PTR_07317d28 = 0;
      ...
      if (((cVar6 != '\0') && (*param_1 != param_2)) && (0 < param_1[-0xb])) {
        ...
        *(int *)(lVar7 + 0x10) = param_1[-0xb] + 10;
        func_0x01b490fc(lVar7,param_2,0x46a);
      }
      *puVar4 = 0;
      *(undefined8 *)puVar5 = 0;
    }
    ...
    *param_1 = param_2;
    ...
    if ((int)uVar2 < 0) {
      ...
      func_0x01b1d8c0(uVar2,uVar1,1,&iStack_34);
    }
  }
  return param_1;
}
