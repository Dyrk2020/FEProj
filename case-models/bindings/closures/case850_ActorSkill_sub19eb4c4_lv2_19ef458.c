...
long * case850_ActorSkill_sub19eb4c4_lv2_19ef458(long *param_1,long param_2)
  ...
  if (*param_1 != param_2) {
    if (*(long *)PTR_07319548 == 0) {
      ...
      *PTR_07317d28 = 0;
      ...
      if (((cVar6 != '\0') && (*param_1 != param_2)) && (0 < *(int *)((long)param_1 + -0x124))) {
        lVar7 = func_0x01b4635c();
        lVar7 = *(long *)(lVar7 + 0x38);
        *(int *)(lVar7 + 0x10) = *(int *)((long)param_1 + -0x124) + 0xa5;
        func_0x01b490bc(lVar7,param_2,0x82f);
      }
      *puVar4 = 0;
      *(undefined8 *)puVar5 = 0;
    }
    ...
    *param_1 = param_2;
    ...
    uVar3 = uVar2;
    if ((int)uVar2 < 0) {
      uVar3 = *(uint *)((long)param_1 + (-0x130 - (long)(short)uVar2));
    }
    uVar1 = 0;
    if ((int)uVar2 < 0) {
    ...
    if ((int)uVar3 < 0) {
      ...
      func_0x01b1d968(uVar3,uVar1,0x1b,&lStack_38);
    }
  }
  return param_1;
}
