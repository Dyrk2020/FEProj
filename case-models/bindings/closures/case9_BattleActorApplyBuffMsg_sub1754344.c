...
void case9_BattleActorApplyBuffMsg_sub1754344(undefined8 param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    lVar2 = func_0x0174b938(param_1,1,0x736d217,0x736d216,1);
    uVar4 = *(undefined8 *)(lVar2 + 8);
  }
  uVar3 = func_0x0124e990(param_1,0xfff0b9d7);
  func_0x017543b8(param_1,uVar4,uVar3);
  return;
}
