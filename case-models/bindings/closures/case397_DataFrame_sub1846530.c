// ===== case397_DataFrame_sub1846530 @ 01846530 (DecompileAt3: cleared stale instructions at entry) =====


undefined8 *
case397_DataFrame_sub1846530
...

{
  ...
  *puVar2 = param_3;
  puVar2[1] = param_4;
  func_0x0124ec90(*param_1,&UNK_01846d8c,1);
  ...
  if ((param_5 != 0) || (param_6 != 0 && (param_6 & 1) != 0)) {
    ...
    *plVar3 = param_5;
    plVar3[1] = param_6;
    func_0x0124ec90(*param_1,&UNK_01846e00,1);
    uVar4 = *param_1;
