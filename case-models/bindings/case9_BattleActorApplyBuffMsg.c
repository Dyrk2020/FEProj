// ===== case9_BattleActorApplyBuffMsg @ 0168e210 (DecompileAt3: cleared stale instructions at entry) =====
// removed existing function case9-BattleActorApplyBuffMsg


void case9_BattleActorApplyBuffMsg(undefined8 param_1)

{
  ...
  func_0x01753f80(&uStack_30,&UNK_0575dd00,&uStack_40,0x736d101);
  puVar4 = (undefined8 *)lua_newuserdata(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01753f64;
  lua_pushcclosure(uStack_30,&UNK_01754344,1);
  ...
  lua_pushstring(uVar1,&UNK_05784488);
