// ===== case5_BattleActorUseMultiSkillMsg @ 0168d8d0 (DecompileAt3: cleared stale instructions at entry) =====
// removed existing function case5-BattleActorUseMultiSkillMsg


void case5_BattleActorUseMultiSkillMsg(undefined8 param_1)

{
  ...
  func_0x0175276c(&uStack_30,&UNK_0575dc7a,&uStack_40,0x736d101);
  puVar4 = (undefined8 *)lua_newuserdata(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01752764;
  lua_pushcclosure(uStack_30,&UNK_01752b30,1);
  ...
  lua_pushstring(uVar1,&UNK_0575dc96);
