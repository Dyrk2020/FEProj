...

{
  ...
  func_0x017571ac(&uStack_30,&UNK_0577381d,&uStack_40,0x736d101);
  puVar4 = (undefined8 *)lua_newuserdata(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_01757194;
  lua_pushcclosure(uStack_30,&UNK_01757570,1);
  ...
  lua_pushstring(uVar1,&UNK_0575dd80);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_0175719c;
  lua_pushcclosure(uStack_30,&UNK_01757694,1);
  lua_pushvalue(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  lua_rawgetp(uStack_30,0xfffffffb,0x6e7);
  lua_pushvalue(uVar1,0xfffffffe);
  uVar3 = lua_absindex(uVar1,0xfffffffe);
  lua_pushstring(uVar1,&UNK_0575dd8c);
  lua_rotate(uVar1,0xfffffffe,1);
  lua_rawset(uVar1,uVar3);
  lua_settop(uVar1,0xfffffffd);
  uVar1 = uStack_30;
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_017571a4;
  lua_pushcclosure(uStack_30,&UNK_017577b8,1);
  lua_pushvalue(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  lua_rawgetp(uStack_30,0xfffffffb,0x6e7);
  lua_pushvalue(uVar1,0xfffffffe);
  uVar3 = lua_absindex(uVar1,0xfffffffe);
  lua_pushstring(uVar1,&UNK_0575dd95);
  lua_rotate(uVar1,0xfffffffe,1);
  lua_rawset(uVar1,uVar3);
  lua_settop(uVar1,0xfffffffd);
  uVar1 = uStack_30;
