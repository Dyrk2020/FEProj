...

{
  ...
  func_0x0175c58c(&uStack_30,&UNK_0575de8c,&uStack_40,0x736d101);
  puVar4 = (undefined8 *)lua_newuserdata(uStack_30,0x10);
  puVar4[1] = 0;
  *puVar4 = &UNK_0175c57c;
  lua_pushcclosure(uStack_30,&UNK_0175c950,1);
  ...
  lua_pushstring(uVar1,&UNK_0575de9c);
  ...
  puVar4[1] = 0;
  *puVar4 = &UNK_0175c584;
  lua_pushcclosure(uStack_30,&UNK_0175ca74,1);
  lua_pushvalue(uStack_30,0xffffffff);
  uVar1 = uStack_30;
  lua_rawgetp(uStack_30,0xfffffffb,0x6e7);
  lua_pushvalue(uVar1,0xfffffffe);
  uVar3 = lua_absindex(uVar1,0xfffffffe);
  lua_pushstring(uVar1,&UNK_0575dea8);
  lua_rotate(uVar1,0xfffffffe,1);
  lua_rawset(uVar1,uVar3);
  lua_settop(uVar1,0xfffffffd);
  uVar1 = uStack_30;
